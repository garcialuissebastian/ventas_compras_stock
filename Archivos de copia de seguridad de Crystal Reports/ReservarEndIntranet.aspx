<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReservarEndIntranet.aspx.cs" Inherits="HardSoft.App.ORL.ReservarEndIntranet" %>
...
box-shadow: 0 4px 5px #555; text-align:center; " >
    ...
    <script  >
        ...
        function SalirJs() {
            ...
            window.location.href = "/App/ORL/ReservarIntranet.aspx";
        }
        function AltaJs() {
