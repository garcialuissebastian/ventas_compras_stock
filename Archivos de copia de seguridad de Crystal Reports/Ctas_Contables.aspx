<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" AutoEventWireup="true" CodeBehind="Ctas_Contables.aspx.cs" Inherits="HardSoft.App.OAA.Ctas_Contables" %>
...
<div >
 ...
 <asp:TextBox ID="TxtNombre" runat="server" class="form-control"    autocomplete="off"></asp:TextBox>
           ...
           <div class="form-group">
         <label for="TxtNombre" class="control-label col-xs-4">Codigo</label>
         <div class="col-xs-8">

 <asp:TextBox ID="TxtCodigo" runat="server" class="form-control"    autocomplete="off"></asp:TextBox>
            ...
            .on("changed.jstree", function (e, data) {
                if (data.selected.length) {
                   ...
                   // alert('The selected node is: ' + data.instance.get_node(data.selected[0]).text);
                    ...
                    $("#Main_TxtNombre").val(data.instance.get_node(data.selected[0]).original.Nombre);
                    $("#Main_TxtCodigo").val(data.instance.get_node(data.selected[0]).original.Codigo);
