...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesOrden.aspx.cs" Inherits="HardSoft.App.OAA.CbtesOrden" %>
...
<select id="cmbTipoCbate" class="form-control" style="text-transform: uppercase;"> 
  ...
  <div class="form-group" id="TipoTranferencia" style="display:none">
         <label for="TxtNombre" class="control-label col-xs-4"> Opción de Transferencia	</label>
         <div class="col-xs-8">
 

<select id="cmbTipoTraferencia" class="form-control" style="text-transform: uppercase;"> 
     
							<option value="ADC">&nbsp;Agente de Depósito Colectivo</option>
							<option value="SCA">&nbsp;Sistema de Circulacion Abierta</option> 
                    ...
                    if (ids == "") {
                        return;
                         ...
                         var json = JSON.stringify
                          ...
                          $.ajax({
                              type: "POST",
                              url: "CbtesOrden.aspx/WsListarAsc",
                              data: json,
                              contentType: "application/json; charset=utf-8",
                              dataType: "json",
                              success: (function (Resultado) {
                                  ...
                                  if ($("#cmbTipoCbate").val() == "213" || $("#cmbTipoCbate").val() == "212" || $("#cmbTipoCbate").val() == "12" || $("#cmbTipoCbate").val() == "13" || $("#cmbTipoCbate").val() == "20" || $("#cmbTipoCbate").val() == "21") {
                                      ...
                                      $('#Main_CmbDebe').val($($("#cmbCbateAsc option:selected")).attr("data-debe")).change();
                                      $('#Main_CmbHaber').val($($("#cmbCbateAsc option:selected")).attr("data-haber")).change();
                                  }
...
"Debe Ingresar un Nombre");
        ...
        function jsImpRp(ids)  {
            ...
            $("#cmbTipoCbate").change(function () {
                ...
                $("#TipoTranferencia").hide();
                $("#VerCbteAsc1").hide();
                if ($("#cmbTipoCbate").val() == "213" || $("#cmbTipoCbate").val() == "212" || $("#cmbTipoCbate").val() == "12" || $("#cmbTipoCbate").val() == "13" || $("#cmbTipoCbate").val() == "20" || $("#cmbTipoCbate").val() == "21") {

              //  if ($("#cmbTipoCbate").val() != '0' && $("#cmbTipoCbate").val() != '1' && $("#cmbTipoCbate").val() != '6' && $("#cmbTipoCbate").val() != '11' && $("#cmbTipoCbate").val() != '211' && $("#cmbTipoCbate").val() != '19' && $("#cmbTipoCbate").val() != '1112') {
                    if ($("#hddIdCli").val() != null) {
                        BsqCbteAsc($("#hddIdCli").val());
                        $("#VerCbteAsc1").show();
                    }
            ...
            if ($("#cmbTipoCbate").val() != '0') {
                ...
                try {
                    ...
                    if ($("#cmbTipoCbate").val() == "213" || $("#cmbTipoCbate").val() == "212" || $("#cmbTipoCbate").val() == "12" || $("#cmbTipoCbate").val() == "13" || $("#cmbTipoCbate").val() == "20" || $("#cmbTipoCbate").val() == "21") {
                        ...
                        asc = $("#cmbCbateAsc").val(); // si nota de credito, debito . pongo el cbte asociado si no no.
                    }
                   
                    if (cond_vta == "S") {
                        obj1 = '{"v_obj": { "ImpTrib":"' + v_ImpTrib + '",  "ImpNeto":"' + v_ImpNeto + '","ImpIVA":"' + v_impIva + '" ,"TipoTranferencia":"' + $("#cmbTipoTraferencia").val() + '",  "Id": "0","CbteTipo": "' + $("#cmbTipoCbate").val() + '", "Concepto": "' + $("#cmbTipoVta").val() + '","Vendedor": "' + $("#cmbVendedor").val() + '", "Cliente": "' + $("#hddIdCli").val() + '",  "Fecha": "' + $("#Main_TxtFecha").val() + '",  "DocTipo": "' + v_tipo + '",   "DocNro":"' + $("#Main_TxtDoc").val() + '",  "ImpTotal": "' + $("#IdTotal").text() + '",  "Pago_Efectivo": "' + parseFloat(pesos).toFixed(2) + '",   "Pago_Bancos": "' + $("#TxtPagoBcoEnt").val() + '",    "Pago_Cheques": "' + $("#TxtChTotal").val() + '",   "Pago_Tarjetas": "' + $("#TxTjTotal").val() + '",   "ImporteLetra": "' + impLetra + '", "treintaDias": "' + Ck30dias + '", "Contado": "' + Contado + '", "Tj_Debito": "' + Tj_Debito + '", "Tj_Credito": "' + Tj_Credito + '", "CtaCte": "' + CtaCte + '", "Cheque": "' + Cheque + '", "Otra": "' + Otra + '", "Remito": "' + Remito + '", "anular_Tipo": "' + $("#TxtAnularTipo").val() + '", "anular_Nro": "' + $("#TxtAnularNro").val() + '" ,"anular_fecha": "' + $("#TxtAnularFecha").val() + '","anular_id": "' + asc + '"  , "MonId": "' + $("#Main_cmbMoneda").val() + '" , "MonCotiz": "' + $("#TxtCotizacion").val() + '" ,"FchVtoPago":"' + $("#Main_TxtFechaPagovto").val() + '", "Transferencia": "' + Tranferencia + '", "Haber": "' + $("#Main_CmbHaber").val() + '", "Debe": "' + $("#Main_CmbDebe").val() + '",     "Articulos": [' + $("#hddProd").val() + ']   ,"AlicIva": [' + v_salIvaObj + '] }} ';
                                                ...
                                                if (obj.Resultado == 'R') {
                                                    alert('Cbate n°:' + obj.Id + '- Rechazado:' + obj.Observaciones);
                                                      ...
                                                      if (getUrlParameter('CbteAnular') != null) { // vine de anular cbate  pongo Observaciones='ANULADO NOTA CREDITO Nro: xxxx"
                                                               ...
                                                               $.ajax({
                                                                   type: "POST",
                                                                   url: "CbtesOrden.aspx/WsUpdateCancelar",
                                                                   data: json2,
                                                                   contentType: "application/json; charset=utf-8",
                                                                   dataType: "json",
                                                                   success: function (result) { 
      ...
      //  ListaPrecios();
        // COndicion de venta
            ...
            function ListarContables() {
                ...
                try {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CbtesComprasV2.aspx/WsListarCtas",
                        data: '',
                        async: false,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: (function (Resultado) {
                            ...
                            $.each(Especialidad, function (index, especialidades) {
                                console.log(especialidades.anulado);

                                if (especialidades.anulado == 'P') {
                                    $('#Main_CmbHaber').append(
                                        $('<option></option>').val(especialidades.Id).html(especialidades.nombre)
                                    );
                                }
                                if (especialidades.anulado == 'PN' || especialidades.anulado == 'A') {
                                    $('#Main_CmbDebe').append(
                                        $('<option></option>').val(especialidades.Id).html(especialidades.nombre)
                                    );
                                }
        ...
        function gvCheques() {
            ...
            if ($("#TxtMontoC").val() != "0") {
                ...
                try {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CbtesOrden.aspx/WmAddCheque",
                        data: json,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: (function (Resultado) {
        ...
        function LimpiarTodo() {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesOrden.aspx/WmLimpiarSesion",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success:'',
            ...
            try {
             ...
             $("#Main_TxtOrdenId").val(ids);
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesOrden.aspx/WsbsqCbate",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: (function (Resultado1) {
                            ...
                            $("#hddIdCli").val(Resultado1.d.Cliente);
                                ...
                                $('#cmbCbateAsc').append(
                                    $('<option selected></option>').val(Resultado1.d.Id).html(Resultado1.d.Id)
                                );
                                ...
                                $('#Main_CmbDebe').val(Resultado1.d.Debe).change(); 
                                $('#Main_CmbHaber').val(Resultado1.d.Haber).change();
                  ...
                  var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesOrden.aspx/WsCbteArticulos",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: llenarGrilla,
