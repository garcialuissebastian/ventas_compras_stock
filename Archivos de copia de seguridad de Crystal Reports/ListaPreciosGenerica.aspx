<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" AutoEventWireup="true" CodeBehind="ListaPreciosGenerica.aspx.cs" Inherits="HardSoft.App.Kardex.ListaPreciosGenerica" %>
...
box-shadow: 0 4px 5px #555;
    ...
    <div style="margin-top:0px;text-transform:uppercase"  >
       ...
       <strong> LISTA DE PRECIOS GENERICA </strong> 
            </div>
...
<div class="row" >
   ...
   <div class="form-group" >
      ...
      <div style="color:white;text-align:left; padding-top: 5px;" class="col-xs-3"> 
     <button id="btnCele" type="button" class="btn2 btn-default  pull-left  " onclick="eliminarTodo()">
        ...
        function Rp() {
          ...
          function Buscar() {
                ...
                try { 
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ListaPreciosGenerica.aspx/WsListar",
                        data: json,
  ...
  function ListarDeposito() {
        ...
        function agregar(art) {
               ...
               var json = JSON.stringify
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ListaPreciosGenerica.aspx/WsAgregarArticulo",
                        data: json,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: Buscar,
           ...
           function eliminarTodo() {
                ...
                if (!confirm("Esta seguro que desea eliminarlo todo los articulos de la lista?")) {
                    return;
                        }
               
                    $.ajax({
                        type: "POST",
                        url: "ListaPreciosGenerica.aspx/WseliminarTodo",
                        data: '',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: Buscar,
           ...
           function eliminar(art) {
               ...
               var json = JSON.stringify
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ListaPreciosGenerica.aspx/Wseliminar",
                        data: json,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: Buscar,
