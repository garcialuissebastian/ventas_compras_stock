 <%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Cbtes_RpMayor.aspx.cs" Inherits="HardSoft.App.OAA.Cbtes_RpMayor" %>
      ...
      <script>
          ...
          $("#Resultado").html(" <div class='wait' style=' text-align:center; margin:auto;  padding:2px;'><img src='/images/Loading_icon.gif' width='150' /> </div> ");
                          ...
                          var json = JSON.stringify
                            ({
                                ...
                                "v_valor1": $('#Main_TxtFechaDesde').val(),
                                "v_valor2": $('#Main_TxtFechaHasta').val()
                                    
                            });
                          $.ajax({
                              type: "POST",
                              url: "Cbtes_RpMayor.aspx/WsListar",
                              data: json,
                              contentType: "application/json; charset=utf-8",
                              dataType: "json",
                              success: resultado3,
          ...
          function resultado3(Re) {
            ...
            //1
              ...
              Tabla_Titulo = "<table  id='grilla'    class='table   table-hover table-bordered ' style='width: 100%;'><thead><tr style='background-color: #1ba0b5; font-weight: 700;'> <td   >Fecha</td>  <td   >Documento </td> <td >Debe</td> <td  >Haber </td></tr></thead><tbody>";
            ...
            //  Tabla_Datos = Tabla_Datos + "<tr  style='background-color: #d7eff3; font-weight: 700;'> <td> Nombre </td><td> Tipo </td><td>Nro</td><td>Fecha</td> <td>Venc.</td> <td >Importe Total</td>   <td > </td>  <td ></td>       </tr>";
              ...
              $.each(Pacientes, function (index, pacientes) {
                  ...
                  if (pacientes.Orden=="0") {
   Tabla_Datos = Tabla_Datos + "<tr style='text-align: left; padding-left: 33px; font-weight: bold; background-color: #d7eff3;'> <td colspan='2' >    " + pacientes.Cta+ " </td><td style=' font-weight: bold; background-color: #d7eff3;     text-align: center;'>" + pacientes.Debe+ "</td><td style=' font-weight: bold; background-color: #d7eff3;    text-align: center;'>" + pacientes.Haber+ "</td>      </tr>";
               
                  } else {
    Tabla_Datos = Tabla_Datos + "<tr style='"+color+"'> <td>  " + pacientes.Fecha+ " </td> <td style='text-align: left;'>" + pacientes.Documento_concepto + "</td><td>" + pacientes.Debe+ "</td><td>" + pacientes.Haber+ "</td>      </tr>";
