<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSorl.aspx.cs" Inherits="CSorl" %>
...
<%--<script src='<%=ResolveUrl("../../Script/Webcam_Plugin/jquery.webcam.js") %>' --%>
    
<%--    <script src="../Scripts/Webcam_Plugin/jquery.webcam.js"></script>
 
<script type="text/javascript">
var pageUrl = '<%=ResolveUrl("../Services/CS.aspx") %>';
$(function () {
    jQuery("#webcam").webcam({
        width: 320,
        height: 240,
        mode: "save",
        swffile: '<%=ResolveUrl("../../Script/Webcam_Plugin/jscam.swf") %>',
