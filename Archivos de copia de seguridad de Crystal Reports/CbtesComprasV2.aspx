...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesComprasV2.aspx.cs" Inherits="HardSoft.App.OAA.CbtesComprasV2" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %> 

<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    <style>
        hr {margin-top:3px;margin-bottom: 3px;border: 0;border-top: 1px solid rgb(59,58,58);}
    </style>
  ...
  <ul>
    ...
    <li><a href="#tabsC-1"    >  Compronte</a></li>
...
<div >
    ...
    <div class="input-group-addon">
      <asp:ImageButton ID="ImageFecha" ImageUrl="~/images/calendario.png" ImageAlign="Bottom" OnClientClick="return false;"
    runat="server"   Width="16px" Height="16px"  />
 
        <asp:CalendarExtender ID="CalendarExtender4"   PopupButtonID="ImageFecha" runat="server" TargetControlID="TxtFecha"
    Format="dd/MM/yyyy"   ></asp:CalendarExtender>
        ...
        <label for="TxtNombre" class="control-label col-xs-4"  > Vto.  Pago </label>
...
<select id="cmbTipoCbate" class="form-control" style="text-transform: uppercase;"> 
                 ...
                 <div class="form-group " >
         <label for="TxtNombre" class="control-label col-xs-4">Nro. Comprobante</label>
         <div class="col-xs-2">
  
       <input id="TxtPto" type="text"  class="form-control" style="width:60px;float:left" placeholder="Pto." onkeypress="return acceptNum(event)"  onblur="gvExisteCbte()" />
   
            </div>    <div class="col-xs-4" style="text-align:left">
             <input id="TxtRemito" type="text"  class="form-control" style="width:110px;float:left" placeholder="N°CBTE" onkeypress="return acceptNum(event)" onblur="gvExisteCbte()"/>
...
<asp:TextBox ID="TxtClienteNombre" runat="server"  class="form-control"    ></asp:TextBox>
      ...
      <a class="tooltips" style="cursor:pointer "  onclick="VerCli()">    <img src="../../images/buscar-documentos.png"  style="height:28px" /><span>Buscar Proveedor</span></a> 
             <a class="tooltips" style="cursor:pointer "  onclick="CliNuevo()">   <img src="/images/add-mas.png" style="height: 25px; padding-left:5px;padding-top:2px"><span>Nuevo Proveedor</span></a> 
 ...
 <div class="form-group" style="display:none">
         ...
         <label for="TxtNombre" class="control-label col-xs-4"></label>
         <div class="col-xs-1">
             <input id="ChPrioridad" type="checkbox"   class="form-control" style="    zoom: 135%;"/>      
         </div>
           <div class="col-xs-7" style="text-align:left;font-weight:800">Pagar con prioridad</div>
     </div>
         ...
         <div class="form-group"  >
         <label for="inputName" class="control-label col-xs-2"> DEBE: </label>
         <div class="col-xs-10">
                ...
                <select id="Main_CmbDebe" class="cmbBuscar form-control"  style="width: 100%">  </select> 
                 ...
                 <div class="form-group">
         <label for="inputName" class="control-label col-xs-2">HABER:</label>
         <div class="col-xs-10">

  
               <select id="Main_CmbHaber" class="cmbBuscar form-control"  style="width: 100%">  </select> 
 ...
 <div class="row"  style="  padding-top:5px; padding-left:15px;padding-right:15px">
  ...
  <div class="col-xs-12" style="display:none ;margin-top:6px; background: -webkit-linear-gradient(top,#555,#333); text-align:left;  text-shadow: #969696 0.1em 0.1em 0.2em;   border-radius: 4px;padding:6px;font-weight:800;margin-bottom:10px; color:white;">&nbsp;&nbsp;   Condiciones de Pago  </div>
...
<span> Articulo no perteneciente al inventario DB </span></a>--%>
    ...
    text-align: right;">
          ...
          <button   type="button" class="btn " id="btnAdd" onclick="VerManual()" style="cursor:pointer ;   background-color: red;
    color: white; " >
...
box-shadow: 0 4px 5px #555; text-align:center; " >
    ...
    <span id="btnAgregar1aIco" class=" glyphicon glyphicon-print"></span> Guardar
 </button>
  ...
  <select  id="Main_CmbTipoArticulo" class="form-control">
	...
	<option value="MATERIA PRIMA">MATERIA PRIMA</option>
           ...
           <div class="form-group" style="display:none">
         <label for="inputName" class="control-label col-xs-4">IVA : </label>
         <div class="col-xs-8">
   ...
   <asp:DropDownList ID="CmbIvaCompra" runat="server" CssClass="form-control"  DataTextField="Descripcion"
         ...
         <div class="col-md-12">
             <div class="form-horizontal">
                      <div class="col-md-12  " style="background-color:#deeaea;     border-radius: 4px;padding:6px;font-weight:800;margin-bottom:10px"> Articulo / Servicio</div>
  ...
  <option value="7" style="padding-left:10px;"> unidades</option>
     ...
     <div class="col-md-12  " style="background-color:#deeaea;     border-radius: 4px;padding:6px;font-weight:800;margin-bottom:10px">Precio Compra</div>
             ...
             <asp:TextBox ID="TxtCantManual" onfocus="onFocus(this)" placeholder="1" onblur="onBlur(this)"  runat="server"  CssClass="form-control" onkeypress="return acceptNum(event)" style="width:50px;" Text="1"   ></asp:TextBox>
                     ...
                     <label for="inputName" class="control-label col-xs-2"  >P. Uni $</label>
         <div class="col-xs-2">
             <div > 
 ...
 onblur="onBlur(this)"  ></asp:TextBox>
         ...
         <label for="inputName" class="control-label col-xs-2">P. Final $  </label>
         <div class="col-xs-2">
...
<script>
    ...
    $("#Main_TxtFinalManual").blur(function () {
        ...
        $("#Main_TxtNetoMaual").val(parseFloat(parseFloat($("#Main_TxtFinalManual").val() / parseFloat(neto)).toFixed(2) / parseFloat($("#Main_TxtCantManual").val())).toFixed(2));
 ...
 Tabla_Fin = " </tbody></table>" ; 
     $('#Resultado_kx_proveedor_bcos').html(Tabla_Titulo + Tabla_Datos + Tabla_Fin);
             ...
             function BsqCbteAsc(ids) {
                 try {
                     $('#cmbCbateAsc').empty();
                     if ($('#cmbTipoCbate').val() == '8' || $('#cmbTipoCbate').val() == '13' || $('#cmbTipoCbate').val() == '21') {
                     ...
                     $.ajax({
                         type: "POST",
                         url: "CbtesComprasV2.aspx/WsListarAsc",
                         data: json,
                         contentType: "application/json; charset=utf-8",
                         dataType: "json",
                         success: (function (Resultado) {
                             ...
                             $.each(Especialidad, function (index, especialidades) {
                                 ...
                                 $('#cmbCbateAsc').append(
                                     $('<option  data-debe="' + especialidades.id_pais + '"  data-haber="' + especialidades.anulado +'"  ></option>').val(especialidades.Id).html(especialidades.nombre)
                                 );

                             });
                              
                             $('#Main_CmbDebe').val($($("#cmbCbateAsc option:selected")).attr("data-haber")).change();

                             $('#Main_CmbHaber').val($($("#cmbCbateAsc option:selected")).attr("data-debe")).change();
...
function gvDel_bcos1(ids) {
 ...
 DATOS
         ...
         <label for="TxtNombre" class="control-label col-xs-4">Cod.Proveedor </label>
         <div class="col-xs-3">
 
             <input id="TxtCodMunual" type="text" class="form-control"  />
         </div>
...
<!-- Modal cuerpo--> 
 ...
 <asp:TextBox ID="TxtFinalPop" runat="server"   class="form-control" onkeypress="return acceptNum2(event, this.value)" onfocus="onFocus(this)" onblur="onBlur(this)" style="width: 100px;" placeholder="0.00"  ></asp:TextBox>
...
if(! $("#pnlCondicionVta").is(':visible'))
{
      ...
      $("#pnlCondicionVta").hide();
       ...
       if ($("#Main_TxtFinalPop").val() =="") {
         $("#Main_TxtFinalPop").val("0");
            ...
            function ModalPrecio1(ids, obj) { 
          
                    //para el caso de ingreso manual
                    tableA = document.getElementById("tabla_fact_det");
            ...
            if (tableA != null) {
                        ...
                        for (var i = 1; i < tableA.rows.length; i++) { 
                            if ($(tableA.rows[i]).find('td:eq(3)').text() == ids) { 
                                ...
                                console.log(tableA.rows[i]);

                                console.log($(tableA.rows[i]).find('td:eq(9)').text());
                                 console.log($(tableA.rows[i]).find('td:eq(11)').text());


                                $("#Main_TxtOriginalPop").val($(tableA.rows[i]).find('td:eq(10)').text());
       ...
       if ($("#Main_TxtFinalPop").val() =="") {
         $("#Main_TxtFinalPop").val("0");
            ...
            function modificarPopPrecio() {
              ...
              function modificarPopPorcentaje() {
                  ...
                  console.log($("#Main_TxtOriginalPop").val());
        ...
        function GuardarModalPrecio() { 
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/WsModArticulo2",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
    ...
    var json = JSON.stringify
        ({
            'v_pto': $("#TxtPto").val(),
            'v_cbte': $("#TxtRemito").val(),
            'v_tipo': $("#cmbTipoCbate").val(), 
            'v_tipo': $("#cmbTipoCbate").val() ,
              'v_prov': $("#hddIdCli").val()
    ...
    $.ajax({
        type: 'POST',
        url: 'CbtesCompras.aspx/Existe_ctacte_compras',
        data: json, contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        success: (function (Result) {
            if (Result.d) {
                  $("#TxtRemito").formError(
     "El Cbte ya fue cargado.");
     ...
     $("#TxtPto").removeClass("valid");
 $("#TxtRemito").removeClass("valid");
            }
          }),
    error: erroresJs
    });
      ...
      alert(e);
        ...
        function gvDel_orden(ids) {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/WmBajaOrden",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: (function (result) {
 ...
 //}
           ...
           $("#TxtPagoBco").change();
            ...
            function tarjetaj1() {
             ...
             if ($("#ckTj1").is(":checked")) {
                 ...
                 $("#ckTj1").prop("checked", false).change();
                 $( "#ckTj1" ).prop( "checked", true ).change();
                $("#tarjetaj1").show();
        ...
        function AltaCliJs() {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/WmAlta2Cli",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
        ...
        function Modificado_Completo(Resultado) {
            if (Resultado.d != '1') {
                ...
                limpiarCli();
                alert('El Cuit ya existe en la base de datos de Proveedores.');
            }
        }
    ...
    try {
        ...
        function ListarTipo() {
          ...
          ({
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/WsListarTipo",
                    data: json,
                    async:false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
     ...
     // $("#Main_TxtApellido").val(ape);
        ...
        function Cuit2() {
            ...
            if ($("#Main_TxtDoc").val() !='') {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/validad_doc2",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: (function (Resultado) {
              ...
              //  $("#tabsC").tabs({ active: 1 });
                ...
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                  ...
                  var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesCompras.aspx/WsAddArticuloOrdenes",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
...
if($('#Pecepcion').is(':visible'))
{
   ...
   Tabla_Datos = Tabla_Datos + " <tr >   <td style='width:30px'> <a class='tooltips' onclick='gvDel_kx_percepciones("+ obj.Id_Percep + ");'> <img src='/images/boton-eliminar.png' style='background-position:50%; background-repeat:no-repeat;cursor:pointer'> <span>Eliminar</span></a></td>   <td>" + obj.Percep + " </td> <td>" + obj.Monto + " </td> <td>" + obj.Obs+ " </td> </tr>"; 
       ...
       Tsal = Tsal + parseFloat(obj.Monto);
   });     
 Tabla_Fin = " </tbody></table>" ; 
                          ...
                          ({
                              "v_obj": {
                                  ...
                                  "Cant": $("#Main_TxtCantManual").val(),                                 
                                   ...
                                   "Cont_Venta": $("#Main_CmbHaber").val(),
                                   "Cont_Compra": $('#Main_CmbDebe').val(), 
...
"Debe Ingresar un Nombre");
        ...
        function llenarGrilla(Resultado){ 
           ...
           tarjetaj();
            ...
            $("#cmbCbateAsc").change(function () {

                if ($("#cmbTipoCbate").val() == "213" || $("#cmbTipoCbate").val() == "212" || $("#cmbTipoCbate").val() == "12" || $("#cmbTipoCbate").val() == "13" || $("#cmbTipoCbate").val() == "20" || $("#cmbTipoCbate").val() == "21") {
        ...
        function jsImpRp(ids)  {
            ...
            $("#cmbTipoCbate").change(function () {
                ...
                $("#VerCbteAsc1").hide();
                if ($("#cmbTipoCbate").val() != '7' &&  $("#cmbTipoCbate").val() != '1112' &&   $("#cmbTipoCbate").val() != '0' && $("#cmbTipoCbate").val() != '1' && $("#cmbTipoCbate").val() != '6' && $("#cmbTipoCbate").val() != '11' && $("#cmbTipoCbate").val() != '211' && $("#cmbTipoCbate").val() != '19') {
                    BsqCbteAsc($("#hddIdCli").val());
                    $("#VerCbteAsc1").show();
                }
            ...
            function AltaFact() {
                ...
                if ($("#TxtPto").val() == '') 
                {
                    $("#TxtPto").addClass("valid");
                    alert("El campo Punto de venta del cbte es obligatoria. ");
                    return;
                ...
                if ($("#TxtRemito").val() == '') 
                {
                    $("#TxtRemito").addClass("valid");
                    alert("El campo Nro cbte es obligatoria. ");
                    return;
                            ...
                            if ($("#hddIdCli").val() != "") {
                                if ($("#Main_TxtDoc").val() != "") {
                                    try {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "CbtesComprasV2.aspx/WmAddFc",
                                            data: obj1,
                                            contentType: "application/json; charset=utf-8",
                                            dataType: "json",
                                            async: false,
                                            success: (function (result) {
                                                ...
                                                window.location.href = 'CbtesComprasV2.aspx';
       ...
       if ($("#Main_TxtFinal").val() =="") {
        ...
        function gvChDel(ids) {
            try { 
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/gvCh_del",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (Resultado) {
        ...
        function gvTJDel(ids) {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/gvTJ_del",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (Resultado) {
      ...
      //  ListaPrecios();
        ...
        function gvCheques() {
            ...
            if ($("#TxtMontoC").val() != "0") {
                ...
                try {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CbtesCompras.aspx/WmAddCheque",
                        data: json,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: (function (Resultado) {
        ...
        function LimpiarTodo() {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesComprasV2.aspx/WmLimpiarSesion",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success:'',
            ...
            try { 
             ...
             $("#Main_TxtOrdenId").val(ids);
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesComprasV2.aspx/WsbsqCbate",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: (function (Resultado1) {
                                ...
                                $("#cmbTipoCbate").val(Resultado1.d.CbteTipo); 
                            ...
                            $("#hddIdCli").val(Resultado1.d.Cliente);
                                ...
                                var v_tipo = Resultado1.d.DocTipo;
                                  ...
                                  if (Resultado1.d.Contado=="X") {
                                      ...
                                      if (Resultado1.d.Prioridad=="Pagar con prioridad") {
                                      $("#ChPrioridad").prop("checked", true);
                  ...
                  var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesComprasV2.aspx/WsCbteArticulos",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: llenarGrilla,
                    ...
                    var json = JSON.stringify //
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesComprasV2.aspx/WsCbtePerc",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: resultado_kx_percepciones,
        ...
        //    Buscar_orden();
            ...
            function VerManual() { 
                ...
                $('#ModalManual').on('shown.bs.modal', function () {
                    $('#Main_TxtDescripManual').focus();
                })  
            ...
            $("#BtnAddManual").on("keydown", function (event) {
                if (event.which == 13) {
                    AddArtManual();
                }
            });
        ...
        function VerifySessionState(result) {
         ...
         var today = new Date();
          ...
          var today = dd + '/' + mm + '/' + yyyy;
            ...
            $('#Main_CmbDebe').change(function () {


                if ($('#Main_CmbDebe').val()=='105') {
                      $('#Main_CmbHaber').val('104').trigger('change');
                }

                   if ($('#Main_CmbDebe').val()=='81') {
                      $('#Main_CmbHaber').val('104').trigger('change');
                }

                   if ($('#Main_CmbDebe').val()=='106') {
                      $('#Main_CmbHaber').val('107').trigger('change');
                }

                 if ($('#Main_CmbDebe').val()=='108') {
                      $('#Main_CmbHaber').val('110').trigger('change');
                }
 
                     if ($('#Main_CmbDebe').val()=='111') {
                      $('#Main_CmbHaber').val('1221').trigger('change');
                }

                
                     if ($('#Main_CmbDebe').val()=='112') {
                      $('#Main_CmbHaber').val('104').trigger('change');
                }

                  
                     if ($('#Main_CmbDebe').val()=='115') {
                      $('#Main_CmbHaber').val('114').trigger('change');
                }


                     if ($('#Main_CmbDebe').val()=='113') {
                      $('#Main_CmbHaber').val('114').trigger('change');
                }
                     if ($('#Main_CmbDebe').val()=='116') {
                      $('#Main_CmbHaber').val('114').trigger('change');
                }

                   if ($('#Main_CmbDebe').val()=='117') {
                      $('#Main_CmbHaber').val('114').trigger('change');
                }

                   if ($('#Main_CmbDebe').val()=='118') {
                      $('#Main_CmbHaber').val('110').trigger('change');
                }

                   if ($('#Main_CmbDebe').val()=='119') {
                      $('#Main_CmbHaber').val('120').trigger('change');
                }

                   if ($('#Main_CmbDebe').val()=='121') {
                      $('#Main_CmbHaber').val('104').trigger('change');
                }

                     if ($('#Main_CmbDebe').val()=='123') {
                      $('#Main_CmbHaber').val('107').trigger('change');
                }

                  if ($('#Main_CmbDebe').val()=='122') {
                      $('#Main_CmbHaber').val('107').trigger('change');
                }

                  if ($('#Main_CmbDebe').val()=='125') {
                      $('#Main_CmbHaber').val('107').trigger('change');
                }

                   if ($('#Main_CmbDebe').val()=='126') {
                      $('#Main_CmbHaber').val('127').trigger('change');
                } 

                   if ($('#Main_CmbDebe').val()=='128') {
                      $('#Main_CmbHaber').val('114').trigger('change');
                }

                      if ($('#Main_CmbDebe').val()=='131') {
                      $('#Main_CmbHaber').val('130').trigger('change');
                }


                 if ($('#Main_CmbDebe').val()=='132') {
                      $('#Main_CmbHaber').val('129').trigger('change');
                }

                  if ($('#Main_CmbDebe').val()=='133') {
                      $('#Main_CmbHaber').val('130').trigger('change');
                }
                   if ($('#Main_CmbDebe').val()=='134') {
                      $('#Main_CmbHaber').val('130').trigger('change');
                }
            ...
            $(function () {
                ...
                ListarContablesHaber(); 
                ListarContablesDebe();
                ListarPerc();

                 $('#Main_CmbHaber').val('104').trigger('change');
                $('#Main_CmbDebe').val('105').trigger('change');

 $( "#ckContado" ).prop( "checked", false).change();

                   if (getUrlParameter('Cbte') != null) {
                     llenarGrillaArtCbte(getUrlParameter('Cbte'));
            }
                ...
                function ListarContablesDebe() { 
            try {
 
                $.ajax({
                    type: "POST",
                    url: "CbtesComprasV2.aspx/WsListarCtasDebe",
                    data: '',
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: (function (Resultado) {
                        ...
                        $.each(Especialidad, function (index, especialidades) {
                            ...
                            if (especialidades.anulado=='SI' ) { // ES CUENTA
                             $('#Main_CmbDebe').append(
                                  $('<option></option>').val(especialidades.Id).html(especialidades.nombre) 
                                );
                                 }
            ...
            function ListarContablesHaber() {
                try {

                    $.ajax({
                        type: "POST",
                        url: "CbtesComprasV2.aspx/WsListarCtasHaber",
                        data: '',
                        async: false,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
            ...
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesComprasV2.aspx/WsListarPerc",
                    data: '',
                    async: false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
