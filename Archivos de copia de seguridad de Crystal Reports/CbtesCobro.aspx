...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesCobro.aspx.cs" Inherits="HardSoft.App.OAA.CbtesCobro" %>
     ...
     //   $("#Main_TxtDoc").prop('disabled', true);
        ...
        function ListarTipo() {
          ...
          ({
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCobro.aspx/WsListarTipo",
                    data: json,
                    async:false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
            ...
            try {
             ...
             $("#Main_TxtOrdenId").val(ids);
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesCobro.aspx/WsbsqCbate",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: (function (Resultado1) {
