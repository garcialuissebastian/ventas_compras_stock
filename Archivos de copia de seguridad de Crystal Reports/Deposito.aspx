<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Deposito.aspx.cs" Inherits="HardSoft.App.OAA.Deposito" %>
...
box-shadow: 0 4px 5px #555; text-align:center; " >
    ...
    <span class=" glyphicon glyphicon-floppy-remove"></span> Cerrar
         ...
         <script>
          ...
          function resultadoTb(Resultado) {
