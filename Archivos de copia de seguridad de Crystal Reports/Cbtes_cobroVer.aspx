 <%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Cbtes_cobroVer.aspx.cs" Inherits="HardSoft.App.OAA.Cbtes_cobroVer" %>
...
box-shadow: 0 4px 5px #555;
    ...
    <div style="margin-top:0px;text-transform:uppercase"  >
       ...
       <strong>    Buscar Comprobantes de Cobro </strong> 
            </div>
...
<div class="row" >
            ...
            <div class="form-group" >
                <div class="col-md-12" style="text-align:center; margin:auto; margin-top:10px">
...
box-shadow: 0 4px 5px #555; text-align:center; height: 80px;" >
    ...
    <span class=" glyphicon glyphicon-floppy-save"></span> Nueva Cobro
 </button>
      ...
      <script>
              ...
              if ($('#cmbTipoCbate').val() != '0') {
                  try {
                      ...
                      if (val1 != '') {
                          ...
                          $.ajax({
                              type: "POST",
                              url: "Cbtes_cobroVer.aspx/WsListar",
                              data: json,
                              contentType: "application/json; charset=utf-8",
                              dataType: "json",
                              success: resultado3,
          ...
          function resultado3(Re) {
            ...
            //1
              ...
              Tabla_Titulo = "<table   id='grilla' class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th>  <th>Fecha</th><th>Cbte</th><th>CbteTipo</th> <th>Proveedor</th><th>DocNro</th>  <th>ImpTotal$</th>  <th>Aplicaciones</th> </tr></thead><tbody>";
