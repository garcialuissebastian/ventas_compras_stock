 <%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Cbtes_RpDeudaClientes.aspx.cs" Inherits="HardSoft.App.OAA.Cbtes_RpDeudaClientes" %>
    ...
    <span class=" glyphicon glyphicon-floppy-save"></span> Descargar
      ...
      <script>
          ...
          $("#Resultado").html(" <div class='wait' style=' text-align:center; margin:auto;  padding:2px;'><img src='/images/Loading_icon.gif' width='150' /> </div> ");
                          ...
                          $.ajax({
                              type: "POST",
                              url: "Cbtes_RpDeudaClientes.aspx/WsListar",
                              data: json,
                              contentType: "application/json; charset=utf-8",
                              dataType: "json",
                              success: resultado3,
          ...
          function resultado3(Re) {
            ...
            //1
              ...
              Tabla_Titulo = "<table   id='grilla' class='table   table-hover table-bordered ' style='width: 100%;'><thead><tr style='background-color: #1ba0b5; font-weight: 700;'> <td   >Cliente</td> <td colspan='5' >Comprobante de Origen </td> <td >Importes Aplicados </td> <td  >Saldo </td></tr></thead><tbody>";
              ...
              $.each(Pacientes, function (index, pacientes) {
                  ...
                  if (pacientes.FechaVto_compra == 'Total Por Cliente') {
