 <%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Cbtes_DeudaCliente.aspx.cs" Inherits="HardSoft.App.OAA.Cbtes_DeudaCliente" %>
...
box-shadow: 0 4px 5px #555; text-align:center; height: 80px;" >
        ...
        <button  type="button" class="btn2 btn-default   " onclick="window.location.href='CbtesCobrov2.aspx'" >
    <span class=" glyphicon glyphicon-floppy-save"></span> Nuevo Cobro
 </button>
      ...
      <script>
          ...
          function ListarTipo() {
            ...
            ({
                  ...
                  $.ajax({
                      type: "POST",
                      url: "Cbtes_RpDeudaClientes.aspx/WsListarCmbClientes",
                      data: json,
              ...
              if ($('#cmbTipoCbate').val() != '0') {
                ...
                v_prio = "";
                      ...
                      if (val1 != '') {
                          ...
                          $.ajax({
                              type: "POST",
                              url: "Cbtes_DeudaCliente.aspx/WsListar",
                              data: json,
                              contentType: "application/json; charset=utf-8",
                              dataType: "json",
                              success: resultado3,
            ...
            //1
              ...
              $.each(Pacientes, function (index, pacientes) {
               ...
               //   
                  ...
                  Tabla_Datos = Tabla_Datos + "<tr style='" +linea + "' ><td> <a   style='" + ver2 + "'   class='tooltips' onclick='gvDel3(" + pacientes.Id_compra + " );' > <img src='/images/divisa.png' style='background-position:50%; background-repeat:no-repeat;cursor:pointer' /><span>Cobrar</span>  </a></td>  <td>" + pacientes.Letra_compra + "</td><td> <a class='tooltips' onclick='PopVer(" + pacientes.Id_compra + ",\"VENTAS\");' style='cursor:pointer'> " + pacientes.Cbte_compra +  priori + " <span>Ver Cbte</span></a></td><td>" + pacientes.Fecha_compra + "</td><td>" + pacientes.FechaVto_compra + "</td><td style='border-right: solid;'>" + parseFloat(pacientes.Monto_compra.replace(',', '.')).format(2, 3, '.', ',') + "</td>     <td>" + pacientes.Letra_op + "</td> <td>    <a class='tooltips' onclick='PopVer(" + pacientes.Id_op + ", 1111);' style='cursor:pointer'> " + pacientes.Cbte_op + " <span>Ver Recibo</span></a></td> <td>" + pacientes.Fecha_op + "</td> <td>" + parseFloat(pacientes.Monto_op==''?'0':pacientes.Monto_op).format(2, 3, '.', ',') + "</td><td ><div style='" + rojo + "' > " + saldo  + "</div></td>  </tr>";
          ...
          function gvDel3(ids) {
                ...
                window.location.href = 'CbtesCobroUnico.aspx?CbteAnular=' + ids;
