...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesCobroUnico.aspx.cs" Inherits="HardSoft.App.OAA.CbtesCobroUnico" %>
                            ...
                            if ($("#hddIdCli").val() != "") {
                                if ($("#Main_TxtDoc").val() != "") {
                                    try {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "CbtesCobroUnico.aspx/WmAddFc",
                                            data: obj1,
                                            contentType: "application/json; charset=utf-8",
                                            dataType: "json",
                                            async: false,
            ...
            try {
             ...
             $("#Main_TxtOrdenId").val(ids);
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesCobroUnico.aspx/WsbsqCbate",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: (function (Resultado1) {
