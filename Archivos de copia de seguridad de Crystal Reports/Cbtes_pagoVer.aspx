 <%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Cbtes_pagoVer.aspx.cs" Inherits="HardSoft.App.OAA.Cbtes_pagoVer" %>
...
box-shadow: 0 4px 5px #555;
    ...
    <div style="margin-top:0px;text-transform:uppercase"  >
       ...
       <strong>    Buscar Orden de Pago </strong> 
            </div>
      ...
      <script>
              ...
              if ($('#cmbTipoCbate').val() != '0') {
                  try {
                      ...
                      if (val1 != '') {
                          ...
                          $.ajax({
                              type: "POST",
                              url: "Cbtes_pagoVer.aspx/WsListar",
                              data: json,
                              contentType: "application/json; charset=utf-8",
                              dataType: "json",
                              success: resultado3,
          ...
          function resultado3(Re) {
            ...
            //1
              ...
              Tabla_Titulo = "<table   id='grilla' class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th>  <th>Fecha</th><th>Cbte</th><th>CbteTipo</th> <th>Proveedor</th><th>DocNro</th>  <th>ImpTotal$</th>  <th>Aplicaciones</th><th></th> </tr></thead><tbody>";
