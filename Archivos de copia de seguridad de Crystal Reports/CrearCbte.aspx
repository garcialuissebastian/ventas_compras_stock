<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CrearCbte.aspx.cs" Inherits="HardSoft.App.Cbte.CrearCbte" %>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
        ...
        <br />
          ...
          <asp:DropDownList ID="cmbPtoVta" runat="server">
        ...
        <asp:Button ID="BtnUltimo" runat="server" Text="Ultimo Cbte" OnClick="BtnUltimo_Click" />
    </div>
  </div>
