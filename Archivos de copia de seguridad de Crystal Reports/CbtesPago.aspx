...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesPago.aspx.cs" Inherits="HardSoft.App.OAA.CbtesPago" %>
...
<asp:TextBox ID="TxtClienteNombre" runat="server"  class="form-control"    ></asp:TextBox>
 ...
 <asp:TextBox ID="TxtDoc" runat="server" class="form-control" onkeypress="return acceptNum(event)"  Width="130px"></asp:TextBox>
          ...
          <label for="TxtNombre" class="control-label col-xs-4 text-left"><strong> </strong></label>
               ...
               <div class="form-group">
         <label for="TxtTipoDoc3" class="control-label col-xs-4"> CBTE  </label>
         <div class="col-xs-6">
 
              <select id="Main_TxtCbteCobro" class="cmbBuscar form-control" style="width: 100%" name="cbtes[]" multiple="multiple" >
                  </select>
...
<script>
     ...
     $('#Main_TxtImp').keyup(function (e) {
        ...
        function AltaPopJs2() {
          ...
          'Id_pago': $('#Main_TxrObsItem').val()
            }
          });
          $.ajax({
        type: "POST",
        url: 'CbtesPago.aspx/WmGvAlta_kx_cbtes_pagos_items',
        data: json,
   ...
   Tabla_Titulo =  "  <table    id='grillakx_cbtes_pagos_items' class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th>  <th>Medio de Pago</th><th>Importe</th><th>Cheque</th><th>Fecha Vto.</th><th>Banco</th><th>Observacion</th>  </tr></thead><tbody> "; 
   $.each(v_obj, function (index, obj) {      
   Tabla_Datos = Tabla_Datos + " <tr >     <td style='width:30px'> <a class='tooltips' onclick='gvDel_kx_cbtes_pagos_items("+ obj.Id + ");'> <img src='/images/boton-eliminar.png' style='background-position:50%; background-repeat:no-repeat;cursor:pointer'> <span>Eliminar</span></a></td>   <td>" + obj.Cta_ContableStr + " </td> <td>" + obj.Importe + " </td> <td>" + obj.Cheque + " </td> <td>" + obj.Vto + " </td> <td>" + obj.Banco + " </td> <td>" + obj.Observacion + " </td>   </tr>"; 
 ...
 Tabla_Fin = " </tbody></table>" ; 
    ...
    function gvDel_kx_cbtes_pagos_items(ids) {
      try {
    ...
    $.ajax({
        type: 'POST',
        url: 'CbtesPago.aspx/WmGvDel_kx_cbtes_pagos_items',
        ...
        function jsImpRp(ids)  {
            ...
            function AltaFact() {
                ...
                if (getUrlParameter('CbteAnular') == null) {// si paga un varios cbte
                    ...
                    var saldoOrig = parseFloat($("#IdTotal").text());
                    var saldoPagar = parseFloat($("#IdTotalFinal").text());
             ...
             $("#Main_TxtOrdenId").val(ids);
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            ...
                            dataType: "json",
                            success: (function (Resultado1) {
                                console.log(Resultado1.d.Saldo);
                                $("#Main_TxtClienteNombre").val(Resultado1.d.ClienteNombre);
