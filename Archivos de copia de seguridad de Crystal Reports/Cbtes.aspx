...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
  ...
  <ul>
    <li><a href="#tabsC-1"> Datos</a></li>
       <li><a href="#tabsC-2"> Condiciones de Venta</a></li> 
...
<div    class="row"  style="text-align: right; "  > 
        <div class="col-xs-2"> 
           <label for="formadepago1" style="padding-right:2px">Contado</label>
            <input   id="ckContado"  type="checkbox"   onclick="efectivo()">
            ...
            try {
                ...
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            ...
                            $("#TxtTipoDoc").text(Resultado1.d.DocTipo);
                            }
                                ),
                            error: errores
                });
...
"Debe Ingresar un Nombre");
        ...
        function llenarGrilla(Resultado){
            ...
            $("#ResultadoProv").show();
            $("#ResultadoProv").empty();
            Tabla_Titulo = "<table  id='tabla_fact_det'   class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th> <th>Cod_Sis</th><th>Cod_Man</th><th>Descripción</th><th>Cantidad</th><th>Alic</th><th>Precio $</th><th>Sub Total $</th></tr></thead><tbody>";
                                                ...
                                                if (obj.Resultado == 'R') {
                                                    alert('Cbate n°:' + obj.Id + '- Rechazado:' + obj.Observaciones);
                                                           ...
                                                           if (getUrlParameter('CbteAnular') != null) { // vine de anular cbate  pongo Observaciones='ANULADO NOTA CREDITO Nro: xxxx"
                                                                ...
                                                                console.log($("#Main_TxtOrdenId").val());
                                                               console.log(json2);
                                                               $.ajax({
                                                                   type: "POST",
                                                                   url: "Cbtes.aspx/WsUpdateCancelar",
                                                                   data: json2,
                                                                   contentType: "application/json; charset=utf-8",
                                                                   dataType: "json",
                                                                   success: function (result) { 
             ...
             $("#Main_TxtOrdenId").val(ids);
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                  ...
                  var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "Cbtes.aspx/WsCbteArticulos",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: llenarGrilla,
