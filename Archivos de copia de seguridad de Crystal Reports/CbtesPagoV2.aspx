...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesPagoV2.aspx.cs" Inherits="HardSoft.App.OAA.CbtesPagoV2" %>
...
<select id="cmbTipoCbate" class="form-control" style="text-transform: uppercase;"> 
               ...
               <div class="form-group" style="display:none">
         <label for="TxtNombre" class="control-label col-xs-4"> DEBE</label>
         <div class="col-xs-8"> 
...
<asp:TextBox ID="TxtClienteNombre" runat="server"  class="form-control"    ></asp:TextBox>
             <input id="hddIdCli" type="hidden" value="" />
               ...
               <div class="col-xs-2" style="display:none" id="lupaBuscar">
 ...
 <asp:TextBox ID="TxtDoc" runat="server" class="form-control" onkeypress="return acceptNum(event)"  Width="130px"></asp:TextBox>
          ...
          <label for="TxtNombre" class="control-label col-xs-4 text-left"><strong> </strong></label>
               ...
               <div class="form-group">
         <label for="TxtTipoDoc3" class="control-label col-xs-4">   </label>
         <div class="col-xs-6">
          ...
          <label for="TxtNombre" class="control-label col-xs-2 " id="ImpCbteCobro" style="     font-size: 12px;
    font-weight: bold;
    text-align: left;color: #097f90;"> 0</label>
          ...
          <option value="1"> Productos</option> 
           <option value="2">  Servicios</option> 
            <option value="3">  Productos y Servicios</option>
               ...
               <label for="TxtTotal" class="control-label col-xs-12  pull-right" style=" background-color:#eceae9 ;padding: 10px;     font-size: 24px;" >
              
               <strong> SALDO DEUDOR: <span id="IdTotal" style="color: red;">0</span> </strong>$</label>
 ...
 <div class="row"  style="  padding-top:5px; padding-left:15px;padding-right:15px; display:none">

  
 
  <div class="col-xs-12" style="margin-top:6px; background: -webkit-linear-gradient(top,#555,#333); text-align:left;  text-shadow: #969696 0.1em 0.1em 0.2em;   border-radius: 4px;padding:6px;font-weight:800;margin-bottom:10px; color:white;">&nbsp;&nbsp;   Condiciones de Cobro  </div>
...
<span>Cheques </span></a></div>
 ...
 <div class='row' > 
  ...
  CBTE
       ...
       <div class='col-xs-5' >  
                    <select id="Main_TxtCbteCobro" class=" form-control" style="width: 100%" >
                  </select> 
   </div> 

       
  <div class='col-xs-3' >  
                    <select id="Main_CmbHaber" class="cmbBuscar form-control"  style="width: 100%"> 
                        <option value="96">EFECTIVO</option>
                        <option value="138">1201 BANCO RIO CTA. CORR. EN PESOS 1503/7</option>
                        <option value="139">1202 BANCO RIO CTA CTE EN $ 15297/8</option>
                        <option value="99">CHEQUE PROPIO</option>
                        <option value="99">ECHEQ</option>
                           <option value="102">CHEQUES DIFERIDOS</option> 
                         <option value="101">CHEQUE DE TERCEROS</option>
                         <option value="99">TARJETAS</option>
   ...
   Importe
       ...
       <div class='col-xs-2' >  
           <asp:TextBox ID='TxtImp' runat='server'   class='form-control' autocomplete="off"  placeholder="0" onkeypress="return acceptNum2(event, this.value)" onkeydown="if (event.keyCode == 13) {  return false;} " onfocus="onFocus(this)" onblur="onBlur(this)" Text="0"></asp:TextBox>   
   </div>  
           ...
           <div class='form-group' > 
                 <div class='col-xs-4' >  
           <asp:TextBox ID='TxrObsItem' runat='server'   class='form-control' placeholder="Observaciones"   Text=""></asp:TextBox>   
   </div> 
          ...
          <div class='col-xs-2'  style='text-align:right'>   
              ...
              <button id="btnBuscarFrm" type="button" class="btn2  btn-info  " onclick="AltaPopJs2()">
    <span><strong>+ Agregar</strong> </span> 
    </button>
     </div> 
       
              <div class='col-xs-2' >  
           <asp:TextBox ID='TxtBco' runat='server'   class='form-control' placeholder="Banco"   Text=""></asp:TextBox>   
   </div> 

  <div class='col-xs-2' >  
           <asp:TextBox ID='TxtChequeNro' runat='server'   class='form-control' placeholder="Cheque"   Text="" ></asp:TextBox>   
   </div>  
             <div class="col-xs-2">
       <div class="input-group date" data-provide="datepicker"  id="ImageFecha3"  style="display:none">
    <asp:TextBox ID="VtoCh" runat="server"  placeholder="dia/mes/año"  CssClass="campoFecha form-control" ></asp:TextBox> 
    <div class="input-group-addon"> 
      <asp:ImageButton ID="ImageFecha2" ImageUrl="~/images/calendario.png" ImageAlign="Bottom" OnClientClick="return false;"
    runat="server"   Width="16px" Height="16px"  />
 
        <asp:CalendarExtender ID="CalendarExtender4"   PopupButtonID="ImageFecha2" runat="server" TargetControlID="VtoCh"
    ...
    <div class='col-sm-12' style='margin-top:5px; margin-right: 0px;'> 
              <div id='Resultado_kx_cbtes_pagos_items' style='overflow: auto;  height: 220px; width: 100%; '>    
      <div >    
     </div>   
     <table   id='grillakx_cbtes_pagos_items'></table>   
   </div>   
   </div>  
      ...
      <div class="row"> 
          <div class="col-sm-6"></div>
           <div class="col-sm-6" style="text-align:right">
               ...
               <strong> TOTAL A PAGAR: <span id="IdTotalFinal" style="color: red;">0</span> </strong>$</label>
...
<div class="row"  style="      background: rgba(245, 245, 245, 0.51);
    margin-left: 0px;
    margin-right: 0px;
    margin-top: 5px;
    /* padding: 20px; */
...
<div class="row">
    <div class="col-xs-12">
    <div id="ResultadoProv"  style="overflow-y: auto; overflow-x: hidden;  width: 100%; background-color:rgb(240, 244, 251) ">
...
<span>Forma de Pago </span></a> </div>
          ...
          <label for="TxtTotal" class="control-label   pull-left" style="  padding: 10px;     font-size: 16px;" >
               ...
               <strong>  <span id="IdTotalLetra"  ></span> </strong></label>
...
<script>
    ...
    $("#Main_TxtImp").keyup(function (e) {
        ...
        function AltaPopJs2() {
            try {
                   ...
                   if ( $('#Main_TxtCbteCobro').val()==''||$('#Main_TxtCbteCobro').val()=='0'||$('#Main_TxtCbteCobro').val()==null) {
                                      
                       alert("Seleccione un proveedor y comprobante a pagar.");
                                        return;
                } 
                    ...
                    if ( $('#Main_TxtImp').val()==''||$('#Main_TxtImp').val()=='0') {
                                      
                                       $('#Main_TxtImp').addClass("valid");
                                        return;
                                    } else {
                                       
                                          $('#Main_TxtImp').removeClass("valid");
                }

                if ($('#Main_CmbHaber option:selected').text() == 'CHEQUE PROPIO' || $('#Main_CmbHaber option:selected').text() == 'CHEQUES DIFERIDOS' || $('#Main_CmbHaber option:selected').text() == 'CHEQUE DE TERCEROS') {
                       if ( $('#Main_TxtChequeNro').val()==''||$('#Main_TxtChequeNro').val()=='0') {
                                      
                                       $('#Main_TxtChequeNro').addClass("valid");
                                        return;
                                    } else {
                                       
                                          $('#Main_TxtChequeNro').removeClass("valid");
                    }

                        if ( $('#Main_VtoCh').val()=='') {
                                      
                                       $('#Main_VtoCh').addClass("valid");
                                        return;
                                    } else {
                                       
                                          $('#Main_VtoCh').removeClass("valid");
                }
                } 

                var idpp = $('#Main_TxtCbteCobro').val();

                console.log(parseFloat($("#Main_TxtImp").val()));
                console.log( parseFloat($("#"+idpp).attr("data-saldo")) );
                if (  parseFloat($("#Main_TxtImp").val().replace(',', '.'))  >   parseFloat($("#"+idpp).attr("data-saldo").replace(',', '.'))     ) {
                    alert("El importe es mayor al saldo del comprobante seleccionado.");
                  $("#Main_TxtImp").addClass("valid");
                                        return;
                }{
          ...
          ({
            'v_obj': {
          'Id': '',
                  'Cta_Contable': $('#Main_CmbHaber').val(),
           'Cta_ContableStr': $('#Main_CmbHaber option:selected').text(),
          'Importe': $('#Main_TxtImp').val(),
          'Cheque': $('#Main_TxtChequeNro').val()==''?'-':$('#Main_TxtChequeNro').val(),
          'Vto': $('#Main_VtoCh').val()==''?'-': $('#Main_VtoCh').val(),
          'Banco': $('#Main_TxtBco').val()==''?'-':$('#Main_TxtBco').val(),
          'Observacion': $('#Main_TxrObsItem').val()==''?'-':$('#Main_TxrObsItem').val(),
                  'Cbte_Id': $('#Main_TxtCbteCobro').val(),
                  'cta_compras': $("#"+idpp).attr("data-contable"),
                  'Saldo':$("#"+idpp).attr("data-saldo").replace(',', '.'),
                    'Fc': $('#Main_TxtCbteCobro option:selected').text()
            }
          });
          $.ajax({
        type: "POST",
        url: 'CbtesPagoV2.aspx/WmGvAlta_kx_cbtes_pagos_items',
        data: json,
        contentType:"application/json; charset=utf-8",
        dataType: 'json',
              success:  resultado_kx_cbtes_pagos_items,
        error: erroresJs
    });
      } catch (e) {
        alert(e.message);
    ...
    function resultado_kx_cbtes_pagos_items(Resultado) {
        var selcmd = $('#Main_TxtCbteCobro').val();
        var ori = $("#" + selcmd).attr("data-saldo").replace(',', '.');
   ...
   var Tabla_Datos = '';
          var Tabla_Fin = '';
          var total2 = 0;
   $('#Resultado_kx_cbtes_pagos_items').show();
        $('#Resultado_kx_cbtes_pagos_items').empty();   
        var cbteanterior = "";
         var apagar  = 0;
   Tabla_Titulo =  "  <table    id='grillakx_cbtes_pagos_items' class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th><th>Cbte</th>  <th>Medio de Pago</th><th>Importe</th><th>Cheque</th><th>Fecha Vto.</th><th>Banco</th><th>Observacion</th><th>Saldo</th>  </tr></thead><tbody> "; 
        $.each(v_obj, function (index, obj) {
            var colorsaldo = "color: red;";
            var colorfin = "";
            if (parseFloat(obj.Saldo).toFixed(2) ==0 ) {
                colorsaldo = "color: blue;font-weight: 700;";
            }
            console.log(cbteanterior);

              if (obj.Fc != cbteanterior ) {// si otro recibo
                  colorfin = "border-top: solid;";
                 apagar= apagar+ parseFloat(obj.Saldo_Origen);
             }

   Tabla_Datos = Tabla_Datos + " <tr style='"+colorfin+"'>     <td style='width:30px'> <a class='tooltips' onclick='gvDel_kx_cbtes_pagos_items(\"" + obj.Cta_ContableStr+ "\",\"" +obj.Saldo_Origen+ "\",\"" +obj.Cbte_Id+ "\" );'> <img src='/images/boton-eliminar.png' style='background-position:50%; background-repeat:no-repeat;cursor:pointer'> <span>Eliminar</span></a></td>  <td>" + obj.Fc + " </td>  <td>" + obj.Cta_ContableStr + " </td> <td style='    font-weight: 700;'>" + obj.Importe + " $ </td> <td>" + obj.Cheque + " </td> <td>" + obj.Vto + " </td> <td>" + obj.Banco + " </td> <td>" + obj.Observacion + " </td> <td style='"+colorsaldo+"'>" + obj.Saldo + " $ </td>    </tr>"; 
         total2 = total2 + parseFloat(obj.Importe);
            cbteanterior = obj.Fc ;
          
   });     
        $("#IdTotalFinal").text(parseFloat(total2).toFixed(2));
        $("#IdTotal").text(parseFloat(apagar).toFixed(2));

 Tabla_Fin = " </tbody></table>" ; 
          $('#Resultado_kx_cbtes_pagos_items').html(Tabla_Titulo + Tabla_Datos + Tabla_Fin);

           $("#IdTotalLetra").text( "IMPORTE EN LETRAS: "+ numeroALetras( total2, {
                plural: 'PESOS',
                singular: 'PESO',
                centPlural: 'CENTAVOS',
    ...
    function gvDel_kx_cbtes_pagos_items(ids,ori,cbte) {
      try {
    ...
    $.ajax({
        type: 'POST',
        url: 'CbtesPagoV2.aspx/WmGvDel_kx_cbtes_pagos_items',
    ...
    function CalFinal() {
     ...
     $("#Main_TxtBco").hide();
     $("#Main_TxtChequeNro").hide();
    $("#ImageFecha3").hide();

    $("#Main_CmbHaber").change(function () {

        if ($('#Main_CmbHaber option:selected').text() == "BANCO" || $("#Main_CmbHaber").val() == "139" || $("#Main_CmbHaber").val() == "138") {

              $("#Main_TxtBco").show();
              $("#Main_TxtChequeNro").hide();
               $("#ImageFecha3").hide();
          } else  if ($("#Main_CmbHaber").val() == "99" || $("#Main_CmbHaber").val() == "101" ||  $("#Main_CmbHaber").val() == "102") {

              $("#Main_TxtBco").show();
              $("#Main_TxtChequeNro").show();
               $("#ImageFecha3").show();
        }

        
          if ($("#Main_CmbHaber").val() == "96") { 
              $("#Main_TxtBco").hide();
              $("#Main_TxtChequeNro").hide();
               $("#ImageFecha3").hide();
        }
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
         <div class="modal-header" style="background-color: #efefef;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
         <div class=" col-xs-6 "  style="font-weight: 900;
    font-size: 17px;text-shadow: #969696 0.1em 0.1em 0.2em; padding-left: 20px;">Proveedor</div>
...
<div class="row" >
  ...
  <div class="col-xs-3" >
      ...
      <select id="cmbTipoOp" class="form-control">
          ...
          <option value="2">Cod Cliente</option>
      </select>
...
<div class="col-xs-6">
      <div class="form-horizontal">
        ...
        <div class="col-xs-2"><strong>
            <asp:TextBox ID="txtCant" runat="server" CssClass="form-control" Width="60px" onkeypress="return acceptNum2(event, this.value)" autocomplete="off" onfocus="onFocus(this)" 
 onblur="onBlur(this)" >                
            </asp:TextBox>
            </strong>
               </div>
    ...
    margin-top: -5px;
    font-weight: 500;
">  PRECIO COMPRA FINAL </label>
        <div class="col-xs-3"> 
            <asp:TextBox ID="TxtPCompra" runat="server" CssClass="form-control" Width="80px" Font-Size="Smaller"  >                
            </asp:TextBox>
            
               </div> 
               <div style="display:none"> 
            <asp:TextBox ID="TxtIvaArt" runat="server"   >                
            </asp:TextBox>
...
<div class="col-xs-4"> 
 ...
 <div class="form-group">
        ...
        <div class="col-xs-7">
            <asp:TextBox ID="TxtFinal" runat="server" CssClass="form-control" style="width: 100px;" onkeypress="return acceptNum2(event, this.value)"   onfocus="onFocus(this)" 
 onblur="onBlur(this)"></asp:TextBox>
               </div>
  ...
  <div class="form-horizontal">
          <div class="form-group">
             ...
             <label for="TxtNombre" class="control-label col-xs-5">Desc %</label>
        <div class="col-xs-7">
            <input type="text" id="TxtDescuento" class="form-control" placeholder="%" value="0"  onfocus="onFocus(this)" 
 onblur="onBlur(this)" onkeypress="return acceptNum2(event, this.value)" autocomplete="off" >
               </div>
       ...
       if ($("#Main_TxtFinalPop").val() =="") {
        ...
        function GuardarModalPrecio() { 
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesOrden.aspx/WsModArticulo2",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
     ...
     //   $("#Main_TxtDoc").prop('disabled', true);
        ...
        $(document).ajaxComplete(function () {
            ...
            $(function () {
                ...
                ListarContables(); 
                 $('#Main_CmbHaber').val('138').trigger('change');
                $('#Main_CmbDebe').val('19').trigger('change');
        ...
        function calcular() {
            ...
            var totalF = parseFloat($("#IdTotal").text()) -totalP;
                ...
                $("#IdTotalLetra").text( "IMPORTE EN LETRAS: "+ numeroALetras(  totalP, {
                plural: 'PESOS',
                singular: 'PESO',
                centPlural: 'CENTAVOS',
                centSingular: 'CENTAVO'
        ...
        function llenarArt(obj) {
            ...
            $('#Main_TxtCbteCobro').change(function () {
                $('#Main_CmbHaber').val('138').change();
                $('#Main_TxtImp').val($($("#Main_TxtCbteCobro option:selected")).attr("data-saldo"));

                var pprecio = $($("#Main_TxtCbteCobro option:selected")).attr("data-saldo");
                $("#IdTotal").text(parseFloat(pprecio).toFixed(2));
            }
                );
            function BsqCbteAsc(ids) {
                try {
                     $('#Main_TxtCbteCobro').prop('disabled',false);

                     $('#Main_TxtCbteCobro').append('<option id="0"   data-saldo="0" value="0">No posee Cbtes</option>');
                         var json = JSON.stringify
                            ({
                              "v_valor": ids
                            });
                          $.ajax({
                              type: "POST",
                              url: "Proveedores.aspx/WsCmbSaldo",
                              data: json,
                              contentType: "application/json; charset=utf-8",
                              dataType: "json",
                              async:false,
              ...
              $('#Main_TxtCbteCobro').empty();
        //  $('#Main_TxtCbteCobro').append('<option id="0"   data-saldo="0" value="0">- -</option>');
              $.each(Especialidad, function (index, especialidades) {
                  
                      $('#Main_TxtCbteCobro').append(
                           $('<option  id= '+especialidades.Id+'   data-contable= '+especialidades.anulado+'  data-saldo= '+especialidades.id_pais+'></option>').val(especialidades.Id).html(especialidades.nombre.replace(",","."))
                         );
                                  ...
                                  if (Resultado.d.length < 1) {
                                      ...
                                      $('#Main_TxtCbteCobro').append(
                                          $('<option  ></option>').val("").html("NO POSEE COMPROBANTES PARA PAGAR")
                                      );
                                  }
                    ...
                    $('#Main_TxtImp').val($($("#Main_TxtCbteCobro option:selected")).attr("data-saldo").replace(",","."));
                    $('#IdTotal').text($($("#Main_TxtCbteCobro option:selected")).attr("data-saldo").replace(",", "."));

                   
                   //  $("#Main_TxtCbteCobro").val("0").change();
        ...
        function efectivo() {
         ...
         function resultadoCli(Resultado) {
            ...
            $("#ResultadoCli").show();
            $("#ResultadoCli").empty();
            Tabla_Titulo = "<table   id='grillaCli' class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th><th style='display:none'>Id</th> <th style='display:none'>Manual</th><th>Nombre</th> <th>CUIT</th><th>Tel</th><th>Cel</th><th>Dirección</th> </tr></thead><tbody>";
            $.each(Pacientes, function (index, pacientes) {
                var nomb2 = pacientes.Denominacion;
                Tabla_Datos = Tabla_Datos + "<tr onclick='llenarArt(this)' style='cursor:pointer;'> <td style='background-image:url(/images/seleccionar-objeto.png); background-position:50%; background-repeat:no-repeat;'> </td><td style='display:none'>" + pacientes.Id + "</td><td style='display:none'>" + pacientes.Cod_Manual + "</td><td>" + pacientes.Denominacion +  "</td> <td>" + pacientes.Cuit + "</td><td>" + pacientes.Emp_Tel + "</td><td>" + pacientes.Emp_Cel + "</td><td>" + pacientes.Calle + ' N° ' + pacientes.Numero + "</td> </tr>";
            });
        ...
        function ListarTipo() {
          ...
          ({
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesPago.aspx/WsListarTipo",
                    data: json,
                    async:false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
     ...
     // $("#Main_TxtApellido").val(ape);
        ...
        function Cuit2() {
            ...
            if ($("#Main_TxtDoc").val() !='') {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesOrden.aspx/validad_doc2",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: (function (Resultado) {
            ...
            $("#Main_cmbMoneda").change(function () { 
                if ($("#Main_cmbMoneda").val() == "PES") {
                 ...
                 var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesOrden.aspx/WsCotizacion",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                ...
                if ($("#Main_txtCant").val() > '0' && $("#Main_txtCant").val()!='') {
                    ...
                    try {
                        ...
                        for (var i = 1; i < tableArt.rows.length; i++) {
                            ...
                            var SelectDep = parseInt(rr.cells[2].innerHTML);

                            var Selectids =  rr.cells[4].innerHTML;

                            var SelectCant = parseFloat(rr.cells[7].innerHTML);
                            var cantFinal = 0;
                        ...
                        var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                          ({
                              ...
                              "PrecioSelect": $("#Main_TxtFinal").val(),
                                "NetoSelect": $("#Main_TxtNeto").val(),
                               "Descuento": $("#TxtDescuento").val()
                          });

                        $.ajax({
                            type: "POST",
                            url: "CbtesOrden.aspx/WsAddArticulo2",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: llenarGrilla,
            ...
            if ($("#Main_TxtDescripManual").val() != "") {
                if ($("#Main_TxtFinalManual").val() != "0:00" && $("#Main_TxtFinalManual").val() != "0") { 
                    ...
                    try {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesOrden.aspx/WsAddArticuloManual",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: llenarGrilla,
...
"Debe Ingresar un Nombre");
        ...
        function jsImpRp(ids)  {
            ...
            function AltaFact() {
                ...
                if (getUrlParameter('CbteAnular') == null) {// si paga un varios cbte

                    var saldoOrig = parseFloat($("#IdTotal").text().replace(',', '.'));
                    var saldoPagar = parseFloat($("#IdTotalFinal").text().replace(',', '.'));
                    
                    //if (saldoPagar != saldoOrig) {
                    //    alert("El saldo a pagar tiene que ser igual al total adeudado.");
                    //    return;
                    //}
            ...
            if ($("#cmbTipoCbate").val() != '0' ) {
                ...
                try {
                 ...
                 if (getUrlParameter('CbteAnular') != null) {// si paga un solo cbte

  arrayCbtes=  '{ "Id": "" ,"CbteId": "' + $("#TxtAnularNro").val()  + '" , "Monto":"' +$("#IdTotalFinal").text().replace(',', '.') + '"}';
                     
                     }
                    var miId = '0';
 
                    if (true) {
                        obj1 = '{"v_obj": { "ImpNeto":"' + v_ImpNeto + '","ImpIVA":"' + v_impIva + '",  "Id": "0","CbteTipo": "' + $("#cmbTipoCbate").val() + '", "Concepto": "' + $("#cmbTipoVta").val() + '","Vendedor": "' + $("#cmbVendedor").val() + '", "Cliente": "' + $("#hddIdCli").val() + '",  "Fecha": "' + $("#Main_TxtFecha").val() + '",  "DocTipo": "' + v_tipo + '",   "DocNro":"' + $("#Main_TxtDoc").val() + '",  "ImpTotal": "' + $("#IdTotalFinal").text() + '",  "Pago_Efectivo": "' + parseFloat(pesos).toFixed(2) + '",   "Pago_Bancos": "' + $("#TxtPagoBcoEnt").val() + '",    "Pago_Cheques": "' + $("#TxtChTotal").val() + '",   "Pago_Tarjetas": "' + $("#TxTjTotal").val() + '",   "ImporteLetra": "' +  $("#IdTotalLetra").text() + '", "treintaDias": "' + Ck30dias + '", "Contado": "' + Contado + '", "Tj_Debito": "' + Tj_Debito + '", "Tj_Credito": "' + Tj_Credito + '", "CtaCte": "' + CtaCte + '", "Cheque": "' + Cheque + '", "Otra": "' + Otra + '", "Remito": "' + Remito + '", "anular_Tipo": "' + $("#TxtAnularTipo").val() + '", "anular_Nro": "" ,"anular_fecha": "' + $("#TxtAnularFecha").val() + '","anular_id": "' + $("#cmbCbateAsc").val() + '"  , "MonId": "' + $("#Main_cmbMoneda").val() + '" , "MonCotiz": "' + $("#TxtCotizacion").val() + '" ,"FchVtoPago":"' + $("#Main_TxtFechaPagovto").val() + '", "Transferencia": "' + Tranferencia + '",  "Cta_contrable": "' + $("#Main_CmbDebe").val() + '",   "Articulos": [' + $("#hddProd").val() + ']   ,"AlicIva": [' + v_salIvaObj + ']  ,"Cbtes": [' + arrayCbtes  + ']   }} ';
                       
                    if ($("#IdTotalFinal").text() != "0") {
                                    ...
                                    try {
                                     ...
                                     ({
                                         "v_obj": {
                                             ...
                                             "config_user": '',
                                             "id_user": '',
                                             "metodo": 'CbtesOrden.aspx/AltaFact() '
                                         }
                                     });
                                                bitacora(json);
                                            })
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.d != null) {
                        ...
                        $("#Main_TxtPCompra").val(parseFloat(result.d.P_Final.replace(',', '.')).toFixed(2));
                        ...
                        $("#Main_TxtIvaArt").val(result.d.Iva_Venta);
                        if ("6" == $("#cmbPrecio").val()) {
      ...
      //  ListaPrecios();
        ...
        function gvCheques() {
            ...
            if ($("#TxtMontoC").val() != "0") {
                ...
                try {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "CbtesCobro.aspx/WmAddCheque",
                        data: json,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: (function (Resultado) {
        ...
        function LimpiarTodo() {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesPago.aspx/WmLimpiarSesion",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success:'',
               ...
               // $( "#ckContado" ).prop( "checked", true );
                ...
                $("#Main_TxtCbteCobro").val(null).trigger('change');
                $("#Main_TxtCbteCobro").prop('disabled', true);
               var selectForm = document.forms[0];
               // limpiaForm(selectForm);
                $(selectForm)[0].reset();  
                v_ImpNeto = parseFloat("0");
        ...
        function BuscarXmodelo() {
            ...
            try {
              ...
              $('#Main_TxtDoc').prop('disabled', true);
           $('#Main_TxtCbteCobro').prop('disabled', true);
            $('#Main_TxtFechaPagovto').prop('disabled', true);
          ...
          //arrayCbtes = "";
          //      if ($('#Main_TxtCbteCobro').val()!=null) { 

          //             var arraycbtes = $('#Main_TxtCbteCobro').val();
          //      for (var i = 0; i < arraycbtes.length; i++) {
                  
          //          idscmd = arraycbtes[i]; 

          //             sal = parseFloat(  parseFloat($("#"+idscmd).attr("data-saldo").replace(',', '.')) +   parseFloat(sal)).toFixed(2);

          //          $("#IdTotal").text(sal).change();
          //           $("#Main_CmbDebe").val($("#"+idscmd).attr("data-contable")).change();
                    

          //      if (arrayCbtes != "") {
          //         arrayCbtes = arrayCbtes + ",";
          //      }
          //     arrayCbtes= arrayCbtes+ '{ "Id": "" ,"CbteId": "' +idscmd + '" , "Monto":"' +$("#"+idscmd).attr("data-saldo").replace(',', '.') + '"}';
                ...
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            ...
                            success: (function (Resultado1) {
                                ...
                                $("#Main_TxtClienteNombre").val(Resultado1.d.ClienteNombre);
                                  $("#Main_CmbDebe").val(Resultado1.d.Cta_contable).change();
                                
                                $("#IdTotal").text(Resultado1.d.Saldo.replace(',', '.')).change();
                                $("#TxtAnularNro").val(ids);
                            ...
                            $("#hddIdCli").val(Resultado1.d.Cliente);
                                ...
                                $("#ImpCbteCobro"). text(Resultado1.d.ImpTotal);
                                 
                               
                                 $('#Main_TxtCbteCobro').append(
                           $('<option    ></option>').val(Resultado1.d.CbteNro).html(Resultado1.d.CbteNro)
                                );
                              
                              //  $('#Main_TxtCbteCobro option[value='+Resultado1.d.CbteNro+']').attr("selected", true);

                               

                                $("#Main_TxtCbteCobro").val(Resultado1.d.CbteNro).change(); 
