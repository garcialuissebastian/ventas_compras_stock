...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesCompras.aspx.cs" Inherits="HardSoft.App.OAA.CbtesCompras" %>
...
<asp:TextBox ID="TxtClienteNombre" runat="server"  class="form-control"    ></asp:TextBox>
 ...
 <div class="row"  style="  padding-top:5px; padding-left:15px;padding-right:15px">
  ...
  <div class="col-xs-12" style="margin-top:6px; background: -webkit-linear-gradient(top,#555,#333); text-align:left;  text-shadow: #969696 0.1em 0.1em 0.2em;   border-radius: 4px;padding:6px;font-weight:800;margin-bottom:10px; color:white;">&nbsp;&nbsp;   Condiciones de Pago  </div>
                                    ...
                                    try {
                                        ...
                                        $.ajax({
                                            ...
                                            success: (function (result) {
                                                ...
                                                window.location.href = 'CbtesCompras.aspx';
      ...
      //  ListaPrecios();
        ...
        function LimpiarTodo() {
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCompras.aspx/WmLimpiarSesion",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success:'',
            ...
            try { 
             ...
             $("#Main_TxtOrdenId").val(ids);
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesCompras.aspx/WsbsqCbate",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: (function (Resultado1) {
                  ...
                  var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            type: "POST",
                            url: "CbtesCompras.aspx/WsCbteArticulos",
                            data: json,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: llenarGrilla,
