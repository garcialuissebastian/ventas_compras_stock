...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="HardSoft.Inicio" enableEventValidation="false" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Hard & Soft - Soluciones Informaticas</title>
    
     <META NAME="AUTHOR" CONTENT="Hard & Soft">
<META NAME="DESCRIPTION" CONTENT=" Somos una empresa especializada en brindar Soluciones Infomáticas caracterizandose por servicios en tecnologías y desarrollos de sistemas informáticos">
<META NAME="KEYWORDS" CONTENT="Desarrollo de software">
    ...
    <META NAME="KEYWORDS" CONTENT="Facturación Onlinea Afip">
...
<body id="home" class="homepage" onload="IrLogin()">
                ...
                <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                ...
                                <small>Ingeniero en Sistemas informáticos</small>
                                <p>Consultor IT</p>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <form id="main-contact-form" name="contact-form" method="post" action="#">
                 ...
                 <%--   <a href="whatsapp://send?phone=+541133894444">Ping me on WhatsApp</a>--%>
                </form>
  ...
  <footer id="footer">
        ...
        <a href="https://qr.afip.gob.ar/?qr=H1w99QOGN7bzBYz8WSxEBQ,," target="_F960AFIPInfo"><img src="https://www.afip.gob.ar/images/f960/DATAWEB.jpg" border="0" height="64px"></a>
 </div>
                    </div>
    ...
    <script src="Scripts/evitar_inspectoweb.js"></script>
    <script>
        ...
        function pantalla() {
            ...
            var v_cab = $('#top-header').height();



            var v_wd = $(window).height(); 

            var v_sal = v_wd - v_cab - 10;
        ...
        $("#Ingreso_uPassword").keyup(function (e) {
            if (e.keyCode == 13) {
                $("#poplog").click();
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-109156664-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());

    gtag('config', 'UA-109156664-1');
</script>
