...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnOaa.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesCobroV2.aspx.cs" Inherits="HardSoft.App.OAA.CbtesCobroV2" %>
...
<script>
        ...
        function AltaPopJs2() {
            try {
                   ...
                   if ( $('#Main_TxtCbteCobro').val()==''||$('#Main_TxtCbteCobro').val()=='0'||$('#Main_TxtCbteCobro').val()==null) {
                       ...
                       alert("Seleccione un cliente y comprobante a pagar.");
                                        return;
                } 
          ...
          $.ajax({
        type: "POST",
        url: 'CbtesCobroV2.aspx/WmGvAlta_kx_cbtes_pagos_items',
        data: json,
 ...
 Tabla_Fin = " </tbody></table>" ; 
    ...
    $("#Main_CmbHaber").change(function () {
          ...
          if ($('#Main_CmbHaber option:selected').text() == "BANCO") {
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
         <div class="modal-header" style="background-color: #efefef;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
         <div class=" col-xs-6 "  style="font-weight: 900;
    font-size: 17px;text-shadow: #969696 0.1em 0.1em 0.2em; padding-left: 20px;">Cliente</div>
     ...
     //   $("#Main_TxtDoc").prop('disabled', true);
        ...
        $(document).ajaxComplete(function () {
            ...
            $(function () {
                ...
                ListarContables(); 
                  // $('#Main_CmbHaber').val('96').trigger('change');
        ...
        //  $('#Main_TxtCbteCobro').append('<option id="0"   data-saldo="0" value="0">- -</option>');
              $.each(Especialidad, function (index, especialidades) {
                      ...
                      $('#Main_TxtCbteCobro').append(
                           $('<option  id= '+especialidades.Id+'   data-contable= '+especialidades.anulado+'  data-saldo= '+especialidades.id_pais+'></option>').val(especialidades.Id).html(especialidades.nombre)
                         );
                                  ...
                                  if (Resultado.d.length < 1) {
                                      ...
                                      $('#Main_TxtCbteCobro').append(
                                          $('<option  ></option>').val("").html("NO POSEE COMPROBANTES PARA COBRAR")
                                      );
                                  }
        ...
        function efectivo() {
         ...
         function resultadoCli(Resultado) {
            ...
            $("#ResultadoCli").show();
            $("#ResultadoCli").empty();
            Tabla_Titulo = "<table   id='grillaCli' class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th> <th style='display:none'>Id</th> <th style='display:none'>Manual</th> <th>Nombre</th><th>TipoDoc</th><th>N°Doc</th><th>Tel</th><th>Cel</th><th>Dirección</th> </tr></thead><tbody>";
        ...
        function ListarTipo() {
          ...
          ({
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesCobroUnico.aspx/WsListarTipo",
                    data: json,
                    async:false,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
