<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="miCuentaNewPers.ascx.cs" Inherits="intranet.App.UsrCtrl.miCuentaNewPers" %>
    ...
    <div id="miCuenta-container">
        ...
        <div id="footer-accesos" class="header-rdw__user-links" style="padding-top:15px">
            ...
            <ul class="list-unstyled" >
                ...
                <li ><a href="ModificarPwdIntranet.aspx"   ><span class="glyphicon glyphicon-lock
