...
{
    public partial class Cbtes_Ver : System.Web.UI.Page
    {
        ...
        protected void BtnImp_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ppr = Bllkx_cbtes.DameInstancia().PathReportCbteJuan(TxtTipoRep.Text);
        ...
        public static List<Be.kx_cbtes> WsListar(string v_tipoCbate, string v_tipo, string v_valor1, string v_valor2)
        {
            try
            {
                ...
                list = Bll.Bllkx_cbtes.DameInstancia().WsListar(v_tipoCbate, v_tipo, v_valor1.ToUpper(), v_valor2.ToUpper(), user, conf);
