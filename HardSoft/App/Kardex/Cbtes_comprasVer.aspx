 <%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="Cbtes_comprasVer.aspx.cs" Inherits="HardSoft.App.Kardex.Cbtes_comprasVer" %>
      ...
      <script>
          ...
          function resultado3(Re) {
            ...
            //1
              ...
              Tabla_Titulo = "<table   id='grilla' class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th></th> <th></th><th>Fecha</th><th>Cbte</th><th>CbteTipo</th> <th>Proveedor</th><th>DocNro</th><th>ImpNeto$</th><th>ImpIVA$</th> <th>ImpTotal$</th>  </tr></thead><tbody>";
