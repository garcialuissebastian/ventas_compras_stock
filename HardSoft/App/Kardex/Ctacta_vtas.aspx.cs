...
{
    public partial class Ctacta_vtas : System.Web.UI.Page
    {
...

        {
            try
            {
              ...
              string  Id_config = ((mysql_usuarios)HttpContext.Current.Session["UsuarioActual"]).Config.id;
                list = Bll.Bllkx_asiento_diario.DameInstancia().Listar_kx_ctacte_vtas(v_tipo, v_valor.ToUpper().Trim(), v_valor1.ToUpper().Trim(), Id_config);
