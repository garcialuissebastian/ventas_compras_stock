...
{
    public partial class ArticuloFarmacia : System.Web.UI.Page
    {
    ...
    [WebMethod()]
        ...
        public static List<Be.Combos> WsListarTipoInsumos()
        {
            try
            {
                ...
                cc = new Combos();
                cc.descripcion = "otros";
                cc.valor = "otros";
                list.Add(cc);

                 cc = new Combos();
                 cc.descripcion = "medicamento";
                 cc.valor = "medicamento";
                list.Add(cc);


                cc = new Combos();
                cc.descripcion = "descartable";
                cc.valor = "descartable";
                list.Add(cc);


                cc = new Combos();
                cc.descripcion = "psicofármaco/estupefaciente";
                cc.valor = "psicofármaco/estupefaciente";
                list.Add(cc); 
        ...
        [WebMethod()]
         ...
         public static List<Be.kx_articulo> WsListarArticulo(string v_tipo, string v_valor)
         {
             try
             {
                 ...
                 string user = ((mysql_usuarios)HttpContext.Current.Session["UsuarioActual"]).Config.id;
                user = "26"; // para q vea el vademe de ms
                 list = Bll.Bllkx_articulo.DameInstancia().Listar(v_tipo, v_valor.ToUpper().Trim(),user,"Farmacia");
                 HttpContext.Current.Session["art"] = list;
         ...
         public static Be.kx_articulo WsListarArticuloId(string v_id)
         {
             try
             {
                ...
                if (user == "28") {
                 ...
                 list = Bll.Bllkx_articulo.DameInstancia().Listar("99", v_id.ToUpper().Trim(),user,"Farmacia");
         ...
         public static List<Be.kx_deposito_reposicion> WsListarDep_IdArt(string v_tipo, string v_valor)
         {
             try
             {
                ...
                list = Bll.Bllkx_deposito_reposicion.DameInstancia().ListarFarmacia( v_tipo,  v_valor,user);
        ...
        public static List<Kc_Lote> WmAddLote(string v_id, string v_dep, string v_cant, string v_motivo, string v_remito, string v_origen, string v_proveedor, string v_comentario, string v_tipo_ingreso, string v_lote, string v_vto  )
        {
            try
            {
                ...
                user = ((mysql_usuarios)HttpContext.Current.Session["UsuarioActual"]).ID_USUARIO;
                list = Bll.Bllkx_articulo.DameInstancia().ListarKc(v_id, user);
