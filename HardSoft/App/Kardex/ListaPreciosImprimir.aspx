<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" AutoEventWireup="true" CodeBehind="ListaPreciosImprimir.aspx.cs" Inherits="HardSoft.App.Kardex.ListaPreciosImprimir" %>
...
box-shadow: 0 4px 5px #555;
    ...
    <div style="margin-top:0px;text-transform:uppercase"  >
       ...
       <strong> IMPRIMIR  LISTAS DE PRECIOS  </strong> 
            </div>
...
<div class="row" >
   ...
   <div class="form-group" >
      ...
      <div style="color:white;text-align:right; padding-top: 5px;" class="col-xs-4"> 
  ...
  <div class="col-xs-3" >
    ...
    <div class="col-xs-2" >
              ...
              <button id="btnAgregar33" type="button" class="btn2 btn-default  pull-left  " onclick="Rp()" >
...
<div class="row">
    <div style="margin:auto;    text-align: center;">
      ...
      <asp:HiddenField ID="HiddenField1" runat="server"   />
       ...
       <div   style="margin-top:5px; background-color:#333; padding:10px;border-radius: 10px 10px 10px 10px;
border: 1px solid;
box-shadow: 0 4px 5px #555; text-align:center; margin-top:200px " >
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.d != null) {
                            ...
                            $('#cmbPrecio').append(
                                      $('<option></option>').val('99').html('Lista Reducida' )
                            );

                             $('#cmbPrecio').append(
                                      $('<option></option>').val('98').html('Lista Ofertas' )
                            );

                               $('#cmbPrecio').append(
                                      $('<option></option>').val('97').html('Lista Generica' )
                            );
                            $('#cmbPrecio').append(
