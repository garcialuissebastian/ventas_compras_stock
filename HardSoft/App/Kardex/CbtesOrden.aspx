...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesOrden.aspx.cs" Inherits="HardSoft.App.Kardex.CbtesOrden" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
  ...
  <ul>
       <li ><a href="#tabsC-3"  style="background-color: #ffe8e8;">Ordenes de Ventas </a></li> 
...
<div id="tabsC-3" style="background-color: #f1f1f1;"> 
<div>
 ...
 <div class='row' > 
   ...
   <div id="B_Fechas"  > 
    ...
    runat="server"   Width="16px" Height="16px"  />
        ...
        <asp:CalendarExtender ID="CalendarExtender3"   PopupButtonID="imgPopup12" runat="server" TargetControlID="TxtFechaDesde"
    ...
    runat="server"   Width="16px" Height="16px"  />
        ...
        <asp:CalendarExtender ID="CalendarExtender4"   PopupButtonID="imgPopup" runat="server" TargetControlID="TxtFechaHasta"
    Format="dd/MM/yyyy"   ></asp:CalendarExtender>
    </div>
...
$.ajax({
  ...
  function resultado_orden(Resultado) {
   ...
   Tabla_Titulo =  "  <table    id='grillaorden' class='table   table-hover table-striped' style='width: 100%;'><thead><tr> <th></th> </th> <th><th>Cliente Nombre</th><th>DocTipo</th><th>DocNro</th><th>TelCli</th><th>CbteTipo</th><th>ImpTotal $</th> <th>Cant<br/>Items</th> <th>Vendedor</th><th>Fecha</th><th>Estado</th> </tr></thead><tbody> "; 
      $.each(v_obj, function (index, obj) { 
          ...
          var estado = "<button   type='button' class='btn2  btn-danger ' onclick=' llenarGrillaArt("+ obj.Id + ") '  style='    width: 110px !important;' >  SIN PAGAR   </button>  ";
          if ( obj.Estado !="") {
              estado = "<button   type='button' class='btn2  btn-primary '   onclick=' jsImpRp("+ obj.Estado + ") '  style='    width: 110px !important;'>  PAGADO   </button>  ";
               enular = "";
          } 

   Tabla_Datos = Tabla_Datos + " <tr >     <td style='width:30px'> "+enular+" </td>    <td style='width:30px'> <a class='tooltips' onclick='verArticulosOrden("+ obj.Id + ");'> <img src='/images/Ver2.png' style='background-position:50%; background-repeat:no-repeat;cursor:pointer'> <span>Ver Articulos</span></a></td>  <td>" + obj.ClienteNombre + " </td> <td>" + obj.DocTipo + " </td> <td>" + obj.DocNro + " </td> <td>" + obj.TelCli + " </td> <td>" + obj.CbteTipo + " </td> <td>" + obj.ImpTotal + " </td>  <td>" + obj.Items+ " </td> <td>" + obj.Vendedor + " </td> <td>" + obj.Fecha + " </td> <td>" + estado + " </td> </tr>"; 
   });     
...
<div    class="row"  style="text-align: right; "  > 
        ...
        <div class="col-xs-2">  
          ...
          <div class="col-xs-2"> 
           <label for="formadepago1" style="padding-right:2px">Cuenta Corriente  </label>
             <input    id="CkCtacte"    type="checkbox" onclick="ctacte1()" >
        </div>

        <div class="col-xs-2"> 
           <label for="formadepago1" style="padding-right:2px">Cheque  </label>
            <input   id="CkCheque"    type="checkbox" onclick="Cheque1()">
        </div>
    <div class="col-xs-2"> 
           <label for="formadepago1" style="padding-right:2px">30 Días F.P.F
 </label>
...
"Debe Ingresar un Nombre");
        ...
        function Buscar3() {
            ...
            try {
                ...
                $.ajax({
                    type: "POST",
                    url: "CbtesOrden.aspx/WsListarArticulo",
                    data: json,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
...
({
 ...
 llenarGrilla,
        ...
        document.getElementById("Main_TxtFechaDesde").value = today;
        ...
        document.getElementById("Main_TxtFechaDesde").value = today;
            ...
            $(function () {
                ...
                if ($("#MiCuenta1_LblNombre").text() != 'DIFRAN') {
