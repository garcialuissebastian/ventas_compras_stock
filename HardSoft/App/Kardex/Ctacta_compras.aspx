<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master"  enableEventValidation="false" AutoEventWireup="true" CodeBehind="Ctacta_compras.aspx.cs" Inherits="HardSoft.App.Kardex.Ctacta_compras" %>
...
Cerrar
   ...
   <div class=" container" style="margin-top: 36px; min-height:600px"> 
       ...
       <strong>   CUENTA CORRIENTE DE PROVEEDORES</strong> 
            </div>
...
$.ajax({
    type: 'POST',
    url: 'Ctacta_compras.aspx/WsListar_kx_ctacte',
    data: json,
  ...
  function resultado_kx_asiento_diario(Resultado) {
   ...
   Tabla_Titulo =  "  <table    id='grillakx_asiento_diario' class='display  ' style='width: 100%;text-align: left'><thead><tr> <th></th> <th></th> <th>Fecha</th><th>Proveedor</th><th>Documento</th><th>Debe</th><th>Haber</th><th>Saldo</th>   </tr></thead><tbody> "; 
 ...
 Tabla_Fin = " </tbody></table>" ; 
    ...
    $('#Resultado_kx_asiento_diario tbody').on( 'click', 'tr.group', function () {
         ...
         $(document).ready(function() {
        document.title = 'CUENTA CORRIENTE DE PROVEEDORES'; // para cuando imprimo salga con el nombre  q quiero
         });
