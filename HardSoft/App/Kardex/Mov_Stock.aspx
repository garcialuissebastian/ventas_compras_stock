<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" AutoEventWireup="true" CodeBehind="Mov_Stock.aspx.cs" Inherits="HardSoft.App.Kardex.Mov_Stock" %>
  ...
  <div class='col-xs-3' >  
                   ...
                   <option value='0'>Nombre articulo</option>   
                        ...
                        <option value="3">CodBarra Proveedor</option>
                         <option value="4">Nombre Deposito</option>
                       </select>      
   </div> 
       <div class='col-xs-3' >  
