...
{
    public partial class CbtesOrden : System.Web.UI.Page
    {
...
[WebMethod()]
        ...
        protected void BtnImp_Click(object sender, EventArgs e)
        {
            ...
            LocalReport localReport = new LocalReport();
              ...
              //  
                ...
                string ppr = Bllkx_cbtes.DameInstancia().PathReportCbteJuan(ds.Tables["cab"].Rows[0]["Cod_Letra"].ToString());
        ...
        public static string WmUltimoCierre_cajas()
        {
            try
            {
            ...
            return    Bll.Bllkx_cajas_mov.DameInstancia().UltimoCierre(user);
