...
{
    public partial class ListaPreciosImprimir : System.Web.UI.Page
    {
        ...
        public void reporte( string lista)
        {
            ...
            if (lista=="99") {
                ds = Bll.Bllkx_articulo.DameInstancia().ListaPreciosRp(user.Config.id, "REDUCIDA");
            }

            if (lista == "98")
            {
                ds = Bll.Bllkx_articulo.DameInstancia().ListaPreciosRp(user.Config.id, "OFERTAS");
            }

            if (lista == "97")
            {
                ds = Bll.Bllkx_articulo.DameInstancia().ListaPreciosRp(user.Config.id, "GENERICA");
            }

            if (lista != "98" && lista != "99" && lista != "97")
            {
                ds = Bll.Bllkx_articulo.DameInstancia().ListaPreciosRpXlista(user.Config.id, lista);
            }
