...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesCompras.aspx.cs" Inherits="HardSoft.App.Kardex.CbtesCompras" %>
...
<select id="cmbTipoCbate" class="form-control" style="text-transform: uppercase;"> 
 ...
 <div>
    ...
    <input id="TxtRemito" type="text"  class="form-control" style="width:110px;float:right" placeholder="N°CBTE" onkeypress="return acceptNum(event)"/>
        ...
        //    Buscar_orden();
            ...
            if ($("#cmbTipoCbate").val() == "15") {
                ...
                // responsable inscripto
                  if ($("#cmbTipoCbate").val() == "1") {
                $("#Main_CmdIva").val("0.21");
                $("#Main_CmbIvaCompra").val("0.21");
                }
                  if ($("#cmbTipoCbate").val() == "2") {
                $("#Main_CmdIva").val("0.21");
                $("#Main_CmbIvaCompra").val("0.21");
                }

                  if ($("#cmbTipoCbate").val() == "6") {
                $("#Main_CmdIva").val("0.21");
                $("#Main_CmbIvaCompra").val("0.21");
                }

                     if ($("#cmbTipoCbate").val() == "7") {
                $("#Main_CmdIva").val("0.21");
                $("#Main_CmbIvaCompra").val("0.21");
                }
                     if ($("#cmbTipoCbate").val() == "8") {
                $("#Main_CmdIva").val("0.21");
                $("#Main_CmbIvaCompra").val("0.21");
                }
