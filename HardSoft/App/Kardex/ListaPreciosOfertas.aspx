<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" AutoEventWireup="true" CodeBehind="ListaPreciosOfertas.aspx.cs" Inherits="HardSoft.App.Kardex.ListaPreciosOfertas" %>
...
box-shadow: 0 4px 5px #555;
    ...
    <div style="margin-top:0px;text-transform:uppercase"  >
       ...
       <strong> LISTA DE PRECIOS OFERTAS </strong> 
            </div>
        ...
        function Rp() {
          ...
          function Buscar() {
                ...
                try { 
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ListaPreciosOfertas.aspx/WsListar",
                        data: json,
  ...
  function ListarDeposito() {
        ...
        function agregar(art) {
               ...
               var json = JSON.stringify
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ListaPreciosOfertas.aspx/WsAgregarArticulo",
                        data: json,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: Buscar,
           ...
           function eliminar(art) {
               ...
               var json = JSON.stringify
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ListaPreciosOfertas.aspx/Wseliminar",
                        data: json,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: Buscar,
