...
{
    public partial class CbtesPago : System.Web.UI.Page
    {
        ...
        public static orden WsbsqCbate(string Id_orden)
        {
            try
            {
                orden listArt = Bll.Bllkx_cbtes.DameInstancia().BsqCbatePagar(Id_orden);
        ...
        public static kx_cbtes WmAddFc(Be.kx_cbtes v_obj)
        {
           ...
           v_obj.PtoVta =   ((mysql_usuarios)HttpContext.Current.Session["UsuarioActual"]).Config.PtoVta;
            ...
            try
            {
                ...
                kx.Id = Convert.ToInt32( Bllkx_cbtes.DameInstancia().AltaPago(v_obj)); 
                return kx;
            }
            catch (Exception ex)
            {
