...
{
    public partial class CbtesCompras : System.Web.UI.Page
    {
        ...
        public static string WmAlta2Cli(Be.kx_cliente v_obj)
        {
            ...
            try
            {
                ...
                if (Bll.Bllkx_proveedor.DameInstancia().WsExisteDoc(v_obj.Doc_No, user) == 0)
                {
                    ...
                    return Bll.Bllkx_proveedor.DameInstancia().AltaId(v_obj).ToString();
        ...
        public static List<pais> WsListarTipo()
        {
            try
            {
                ...
                if (tipo == "Monotributo")
                {
                    ...
                    pais pa6 = new pais();
                    pa6.id_pais = "6";
                    pa6.nombre = "Factura B";
                    list.Add(pa6);


                    pais pa8 = new pais();
                    pa8.id_pais = "8";
                    pa8.nombre = "Nota de Crédito B";
                    list.Add(pa8);

                    pais pa7 = new pais();
                    pa7.id_pais = "7";
                    pa7.nombre = "Nota de Débito B";
                    list.Add(pa7);


                    //pais pa1 = new pais();
                    //pa1.id_pais = "1";
                    //pa1.nombre = "Factura A";
                    //list.Add(pa1);

                    //pais pa3 = new pais();
                    //pa3.id_pais = "3";
                    //pa3.nombre = "Nota de Crédito A";
                    //list.Add(pa3);

                    //pais pa2 = new pais();
                    //pa2.id_pais = "2";
                    //pa2.nombre = "Nota de Débito A";
                    //list.Add(pa2);
        ...
        public static List<Be.kx_articulo> WsCbteArticulos(string Id_orden)
        {
            try
            {
                List<Be.kx_articulo> listArt = Bll.Bllkx_cbtes.DameInstancia().Cbte_ArticulosCompras(Id_orden);
        ...
        public static orden WsbsqCbate(string Id_orden)
        {
            try
            {
                orden listArt = Bll.Bllkx_cbtes.DameInstancia().BsqCbteCompras(Id_orden);
            ...
            try
            {
                ...
                foreach (var item in list2)
                {
                    if (item.Id.ToString() == v_id)
                    {
                        ...
                        if (item.PrecioOriginal ==null) { // si viene de ingreso manual

                            item.PrecioOriginal = item.PrecioSelect;
                        }
...
[WebMethod()]
         public static Be.kx_cliente validad_doc2(string v_doc, string v_tipo)
         {
             ...
             string user = ((mysql_usuarios)HttpContext.Current.Session["UsuarioActual"]).Config.id;
             cli =  Bllkx_cbtes.DameInstancia().WsExisteProveedor(v_doc,user);
            ...
            try
            {
                if (HttpContext.Current.Session["SelectArt"] != null)
                {
                    ...
                    string idOrden = v_obj.Id.ToString();
                        ...
                        kx =           tk.Generar_CbateCompra(CAB,v_obj);
        ...
        protected void BtnImp_Click(object sender, EventArgs e)
        {
            ...
            if (true)
            {
                ...
                string salida2 = Convert.ToBase64String(arrImg);
                    ...
                    string nombreCbte = ds.Tables["cab"].Rows[0]["PtoVta"].ToString() + ds.Tables["cab"].Rows[0]["CbteDesde"].ToString();
