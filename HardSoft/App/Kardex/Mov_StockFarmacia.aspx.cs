...
{
    public partial class Mov_StockFarmacia : System.Web.UI.Page
    {
        ...
        public static List<kx_stock> WsListar_kx_stock(string v_tipo, string v_valor, string v_dep)
        {
            try
            {
                ...
                list = Bll.Bllkx_articulo.DameInstancia().Listar_kx_stockFarmacia(v_tipo, v_valor.ToUpper().Trim(), "26", v_dep);
