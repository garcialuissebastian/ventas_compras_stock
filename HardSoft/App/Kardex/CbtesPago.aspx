...
<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="CbtesPago.aspx.cs" Inherits="HardSoft.App.Kardex.CbtesPago" %>
...
<asp:TextBox ID="TxtClienteNombre" runat="server"  class="form-control"    ></asp:TextBox>
 ...
 <asp:TextBox ID="TxtCbteCobro" runat="server" class="form-control" ></asp:TextBox>
           
                  </div>
     
 
          <label for="TxtNombre" class="control-label col-xs-4 " id="ImpCbteCobro" style="     font-size: 16px;
    font-weight: bold;
                ...
                var json = JSON.stringify // esta funcion convierte un obj java scrip a json para pasarlo
                        ...
                        $.ajax({
                            ...
                            $("#hddIdCli").val(Resultado1.d.Cliente);
                                ...
                                $("#Main_TxtCbteCobro").val(Resultado1.d.CbteNro);
