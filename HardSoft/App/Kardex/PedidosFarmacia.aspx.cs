...
{
    public partial class PedidosFarmacia : System.Web.UI.Page
    {
        ...
        public static void WmAddGuardar(string v_motivo, string v_dep_origen, string v_dep_destino, string v_remito, string v_comentario)
        {
            try
            {
                ...
                Bll.Bllkx_articulo.DameInstancia().egresoPedidos(kc);
        ...
        public static List<Kc_Lote> WsListarArticuloSkFarmacia(string v_tipo, string v_valor, string v_dep)
        {
            try
            {
                ...
                list = Bll.Bllkx_articulo.DameInstancia().ListarStockFarmaciaAgrupado(v_tipo, v_valor.ToUpper().Trim(), user, "Farmacia", v_dep);
        ...
        public static List<Kc_Lote> WmAddLote(string v_id, string v_dep, string v_cant, string v_motivo, string v_remito, string v_origen, string v_proveedor, string v_comentario, string v_tipo_ingreso, string v_lote, string v_vto, string v_lab, string v_desclab, string v_descArt, string v_cod)
        {
            try
            {
        ...
        protected void report()
        {
            try
            {
                ...
                DataSet dt = Bll.Bllkx_articulo.DameInstancia().ReportPedidos("");
