<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOnRk.Master" AutoEventWireup="true" enableEventValidation="false" CodeBehind="Producto_categoria_ver.aspx.cs" Inherits="HardSoft.App.Ralkal.Producto_categoria_ver" %>
...
box-shadow: 0 4px 5px #555; text-align:center; " >
              ...
              <button id="btnAgregar1" type="button" class="btn2 btn-default   " onclick=" window.location.href='Productos_categoria.aspx?TipoOpA=Add';" >
    ...
    <script>
        ...
        function Buscar() {
            ...
            $.ajax({
                type: "POST",
                url: "Producto_categoria_ver.aspx/WsListar",
                data: json,
        ...
        function CargarVer(Ids) {
            $(location).attr("href", "Productos_categoria.aspx?Ids="+Ids);
        }
        ...
        function resultado(Resultado) {
            ...
            $("#Resultado").show();
            $("#Resultado").empty();
            Tabla_Titulo = "<table class='table   table-hover table-striped' style='width: 100%;'><thead><tr><th>#</th><th>Id</th><th>Nombre</th><th>Descripción</th></tr></thead><tbody>";
            $.each(Pacientes, function (index, pacientes) {
                Tabla_Datos = Tabla_Datos + "<tr onclick='CargarVer(" + pacientes.Id + ");' style='cursor:pointer;'><td style='background-image:url(/images/ver.png); background-position:50%; background-repeat:no-repeat;'> </td><td>" + pacientes.Id + "</td><td>" + pacientes.Nombre + "</td><td>" + pacientes.Descripcion + "</td></tr>";
            });
