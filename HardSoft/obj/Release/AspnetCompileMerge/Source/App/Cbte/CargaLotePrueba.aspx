<%@ Page Title="" Language="C#" MasterPageFile="~/App/Master/HomeOn.Master" AutoEventWireup="true" CodeBehind="CargaLotePrueba.aspx.cs" enableEventValidation="false" Inherits="HardSoft.App.Cbte.CargaLotePrueba" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <div class="container" style=" margin-top: 15px; ">
        ...
        <h2>MODO PRUEBA - COMPROBANTES NO VALIDOS</h2>
...
color: #222222; "  >
   ...
   ">
         <div style=" font-size:32px; font-weight:600">   <asp:Label ID="lblEmpresa2" runat="server" Text="MI EMPRESA"></asp:Label></div> 
            ...
            <div style="color:#333; font-size:24px;font-weight:500;float: left;    margin-top: 6px;">    <asp:Label ID="lblCuit2" runat="server" Text="1-11111111-1"></asp:Label> - PRUEBA </div>
