...
(function($)
{
	...
	$.fn.wPaint.defaultSettings = {
		...
		menuOffsetX			 : 0,					// offset for menu (left)
		menuOffsetY: 264,					// offset for menu (top)
		...
		disableMobileDefaults: true            	// disable default touchmove events for mobile (will prevent flipping between tabs and scrolling)
	};
