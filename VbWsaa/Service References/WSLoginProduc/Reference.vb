...
Namespace WSLoginProduc
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="https://wsaa.afip.gov.ar/ws/services/LoginCms", ConfigurationName:="WSLoginProduc.LoginCMS")>  _
    Public Interface LoginCMS
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="", ReplyAction:="*"),  _
         System.ServiceModel.FaultContractAttribute(GetType(WSLoginProduc.LoginFault), Action:="", Name:="fault")>  _
        Function loginCms(ByVal request As WSLoginProduc.loginCmsRequest) As WSLoginProduc.loginCmsResponse
    End Interface
    ...
    Public Interface LoginCMSChannel
        Inherits WSLoginProduc.LoginCMS, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class LoginCMSClient
        Inherits System.ServiceModel.ClientBase(Of WSLoginProduc.LoginCMS)
        Implements WSLoginProduc.LoginCMS
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function WSLoginProduc_LoginCMS_loginCms(ByVal request As WSLoginProduc.loginCmsRequest) As WSLoginProduc.loginCmsResponse Implements WSLoginProduc.LoginCMS.loginCms
            Return MyBase.Channel.loginCms(request)
        End Function
        
        Public Function loginCms(ByVal in0 As String) As String
            Dim inValue As WSLoginProduc.loginCmsRequest = New WSLoginProduc.loginCmsRequest()
            inValue.in0 = in0
            Dim retVal As WSLoginProduc.loginCmsResponse = CType(Me,WSLoginProduc.LoginCMS).loginCms(inValue)
