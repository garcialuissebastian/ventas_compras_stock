...
Namespace WSLogin
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName:="WSLogin.LoginCMS")>  _
    Public Interface LoginCMS
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="", ReplyAction:="*"),  _
         System.ServiceModel.FaultContractAttribute(GetType(WSLogin.LoginFault), Action:="", Name:="fault")>  _
        Function loginCms(ByVal request As WSLogin.loginCmsRequest) As WSLogin.loginCmsResponse
    End Interface
    ...
    Public Interface LoginCMSChannel
        Inherits WSLogin.LoginCMS, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class LoginCMSClient
        Inherits System.ServiceModel.ClientBase(Of WSLogin.LoginCMS)
        Implements WSLogin.LoginCMS
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function WSLogin_LoginCMS_loginCms(ByVal request As WSLogin.loginCmsRequest) As WSLogin.loginCmsResponse Implements WSLogin.LoginCMS.loginCms
            Return MyBase.Channel.loginCms(request)
        End Function
        
        Public Function loginCms(ByVal in0 As String) As String
            Dim inValue As WSLogin.loginCmsRequest = New WSLogin.loginCmsRequest()
            inValue.in0 = in0
            Dim retVal As WSLogin.loginCmsResponse = CType(Me,WSLogin.LoginCMS).loginCms(inValue)
